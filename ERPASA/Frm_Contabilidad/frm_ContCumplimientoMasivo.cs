...
{
    public partial class frm_ContCumplimientoMasivo : Form
    {
        ...
        public frm_ContCumplimientoMasivo()
        {
            InitializeComponent();
        }

        private void frm_ContCumplimientoMasivo_Load(object sender, EventArgs e)
        {
            PonerOscuroComboBox();
            CargaDatos();
            //AgregarColumna();
        ...
        private void toolStripButton_guardar_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                {
                    Msbox.Frm_NotificacionesPeligro ng = new Msbox.Frm_NotificacionesPeligro("SELECCIONE AÑO", Color.FromArgb(238, 24, 24), 3);
                    ng.ShowDialog();
                }
                else if (comboBox_mes.Text == "SELECCIONE")
                {
                    Msbox.Frm_NotificacionesPeligro ng = new Msbox.Frm_NotificacionesPeligro("SELECCIONE MES", Color.FromArgb(238, 24, 24), 3);
                    ng.ShowDialog();
                }
                else
                {
                    AlertaGuardarControlCumplimiento();
                }
            }
            else
            {
        ...
        public void AlertaGuardarControlCumplimiento()
        {
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                {
                    objcnlog.EliminarControlCumplimientoConta(
                        comboBox_año.Text,
                        comboBox_mes.Text
                        );
                    ...
                    {
                        objcnlog.GuardarControlCumplimientoConta(
                            dataGridView1[0, i].Value.ToString(),//id
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string MessageBoxTitle = "CARGAR CUMPLIMIENTO";
            string MessageBoxContent = "¿Desea mostrar lista de cumplimiento?";
