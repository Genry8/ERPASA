...
{
    public partial class frm_PartidasCargaMasiva : Form
    {
        ...
        public frm_PartidasCargaMasiva()
        {
            InitializeComponent();
        }

        private void frm_PartidasCargaMasiva_Load(object sender, EventArgs e)
        {
            PonerOscuroComboBox();
            CargaDatos();
            //AgregarColumna();
        ...
        {
            dataGridView1.AllowUserToAddRows = false;
            string MessageBoxTitle = "CARGAR PARTIDAS";
            string MessageBoxContent = "¿Desea mostrar lista de partidas?";
