...
{
    public partial class Frm_CampanaSucursal : Form
    {
        ...
        public Frm_CampanaSucursal()
        {
            InitializeComponent();
        }

        private void Frm_CampanaSucursal_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
            CargarDatosComboBox();
            comboBox_empresaCons.DropDownStyle = ComboBoxStyle.DropDownList;
            comboBox_sucursalCons.DropDownStyle = ComboBoxStyle.DropDownList;
            comboBox_cultivoCons.DropDownStyle = ComboBoxStyle.DropDownList;
            Cargar_Empresa();
            ColumnasDtgv1();
            ColumnasDtgv2();
            //
        ...
        {
            //CARGAR EMPRESA
            comboBox_empresaCons.DataSource = cn_logistica.ListaCBEmpresaTodoAsignacionTI();
            comboBox_empresaCons.DisplayMember = "DesEmp"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            comboBox_empresaCons.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR
        ...
        private void ColumnasDtgv1()
        {
            ...
            dtic = cn_contabilidad.ListaSucursal("%");
            //dt = cn_logistica.ListaSedeComedorEmpresa(comboBox_empresa.Text.Trim(), "%");
        ...
        private void ColumnasDtgv2()
        {
            ...
            string emp, suc, cult;
            if (comboBox_empresaCons.Text == "SELECCIONE")
            { emp = "%"; }
            else { emp = comboBox_empresaCons.Text; }
            if (comboBox_sucursalCons.Text == "SELECCIONE")
            { suc = "%"; }
            else { suc = comboBox_sucursalCons.Text; }
            if (comboBox_cultivoCons.Text == "SELECCIONE")
            { cult = "%"; }
            else { cult = comboBox_cultivoCons.Text; }
            ...
            //declara una tabla donde se llama la lista de los estados
            DataTable dts = new DataTable();
            dts = cn_contabilidad.ListaSucursal(emp);
            //dt = cn_logistica.ListaSedeComedorEmpresa(comboBox_empresa.Text.Trim(), "%");
            ...
            Sucursal.Items.AddRange(rows.ToArray());
            //AÑADIR EL COMBO AL DATAGRIDVIEW
            dataGridView2.Columns.Add(Sucursal);
            ...
            //declara una tabla donde se llama la lista de los estados
            DataTable dtc = new DataTable();
            dtc = cn_contabilidad.ListaCultivo("%", suc);
            //dt = cn_logistica.ListaSedeComedorEmpresa(comboBox_empresa.Text.Trim(), "%");
            ...
            Cultivo.Items.AddRange(rowc.ToArray());
            //AÑADIR EL COMBO AL DATAGRIDVIEW
            dataGridView2.Columns.Add(Cultivo);
            // 
            // Column3
            // 
            DataGridViewComboBoxColumn Etapa = new DataGridViewComboBoxColumn();
            ...
            Etapa.Items.AddRange(rowe.ToArray());
            //AÑADIR EL COMBO AL DATAGRIDVIEW
            dataGridView2.Columns.Add(Etapa);
            ...
            //declara una tabla donde se llama la lista de los estados
            DataTable dtic = new DataTable();
            dtic = cn_contabilidad.ListaConsumidor(emp, suc, cult);
            //dt = cn_logistica.ListaSedeComedorEmpresa(comboBox_empresa.Text.Trim(), "%");
            ...
            IdConsumidor.Items.AddRange(rowic.ToArray());
            //AÑADIR EL COMBO AL DATAGRIDVIEW
            dataGridView2.Columns.Add(IdConsumidor);
            ...
            Campaña.Name = "Campaña";
            Campaña.Width = 85;
            dataGridView2.Columns.Add(Campaña);
            // 
            // Column3
            // 
            DataGridViewTextBoxColumn FechaInicio = new DataGridViewTextBoxColumn();
            ...
            FechaInicio.Name = "FechaInicio";
            FechaInicio.Width = 87;
            dataGridView2.Columns.Add(FechaInicio);
            // 
            // Column3
            // 
            DataGridViewTextBoxColumn FechaFin = new DataGridViewTextBoxColumn();
            ...
            FechaFin.Name = "FechaFin";
            FechaFin.Width = 87;
            dataGridView2.Columns.Add(FechaFin);
            // 
            // Column3
            // 
            DataGridViewTextBoxColumn Factor = new DataGridViewTextBoxColumn();
            ...
            Factor.Name = "Factor";
            Factor.Width = 87;
            dataGridView2.Columns.Add(Factor);
        ...
        {
            if (comboBox_empresaCons.Text == comboBox_empresaCons.Text)
            {
                comboBox_sucursalCons.DataSource = cn_contabilidad.ListaSucursal(comboBox_empresaCons.Text);
                comboBox_sucursalCons.DisplayMember = "Sucursal"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
                comboBox_sucursalCons.ValueMember = "Sucursal"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            }
        }

        private void comboBox_sucursalCons_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox_sucursalCons.Text == comboBox_sucursalCons.Text)
            {
                comboBox_cultivoCons.DataSource = cn_contabilidad.ListaCultivo("%", comboBox_sucursalCons.Text);
                comboBox_cultivoCons.DisplayMember = "Cultivo"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
                comboBox_cultivoCons.ValueMember = "Cultivo"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            }

        }

        private void toolStripButtonBuscar_CampCons_Click(object sender, EventArgs e)
        {
        ...
        public void BuscarReporteCapañaConsumidor()
        {
            //var val = cn_sst.BuscAtencionPaciente(textBox_Dni.Text, dateTimePicker_FecAtencion.Value.Date,textBox_HoraEntrada.Text);
            //if (val == true)
            //{
            ...
            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_contabilidad.ListaReporteCampañaConsumidor(
                emp, suc, cult);
            ...
            Sucursal.Items.AddRange(rows.ToArray());
            //AÑADIR EL COMBO AL DATAGRIDVIEW
            dataGridView2.Columns.Insert(2, Sucursal);
            ...
            Cultivo.Items.AddRange(rowc.ToArray());
            //AÑADIR EL COMBO AL DATAGRIDVIEW
            dataGridView2.Columns.Insert(3, Cultivo);
            // 
            // Column3
            // 
            DataGridViewComboBoxColumn Etapa = new DataGridViewComboBoxColumn();
            ...
            Etapa.Items.AddRange(rowe.ToArray());
            //AÑADIR EL COMBO AL DATAGRIDVIEW
            dataGridView2.Columns.Insert(4, Etapa);
            ...
            IdConsumidor.Items.AddRange(rowic.ToArray());
            //AÑADIR EL COMBO AL DATAGRIDVIEW
            dataGridView2.Columns.Insert(5, IdConsumidor);
        ...
        private void toolStripButtonExcel_CampCons_Click(object sender, EventArgs e)
        {
            objexcel.ExportarExcel(dataGridView2);
        }

        private void toolStripButtonGuardar_CampCons_Click(object sender, EventArgs e)
        {
            textBox1.Focus();
            dataGridView2.AllowUserToAddRows = false;
            if (dataGridView2.Rows.Count > 0)
        ...
        public void guardarCampañaConsumidor()
        {
            string MessageBoxTitle = "REGISTRO";
            string MessageBoxContent = "¿Desea Guardar Registros?";
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    objcnlog.GuardCampañaConsumidorConta(
                        Convert.ToInt32(dataGridView2[0, i].Value.ToString()),
