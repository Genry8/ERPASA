...
namespace ERPASA
{
    public partial class Frm_presentacion_cargando : Form
    {
        Frm_Menu menu = new Frm_Menu();
        Frm_Login login = new Frm_Login();
        cn_usuario objcuserneg = new cn_usuario();

        public Frm_presentacion_cargando()
        {
            InitializeComponent();
        ...
        private void Frm_presentacion_cargando_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
