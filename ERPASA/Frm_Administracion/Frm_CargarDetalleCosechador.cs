...
{
    public partial class Frm_CargarDetalleCosechador : Form
    {
        ...
        public Frm_CargarDetalleCosechador()
        {
            InitializeComponent();
        }

        private void Frm_CargarDetalleCosechador_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarDetalleCosechador()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_administracion.BuscExisteDetalleCosechador(
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date, //Fecha
                        dataGridView1[10, i].Value.ToString().Trim(), //DNI
                        dataGridView1[23, i].Value.ToString().Trim() //TICKET
                        );
                    ...
                    if (exrev == true)
                    {
                        objcnlog.ActualizarDetalleCosechador(
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,//fecha
                        ...
                        Convert.ToDecimal(dataGridView1[12, i].Value),//Jabas
                        Convert.ToDecimal(dataGridView1[13, i].Value),//Kilos
                        Convert.ToDecimal("0"),//Meta
                        Convert.ToDecimal(dataGridView1[15, i].Value),//PrecioUnitario
                        Convert.ToDecimal(dataGridView1[16, i].Value),//Bono
                        Convert.ToDecimal("0"),//Rendimiento
                    ...
                    else //if (dataGridView2[0, i].Value.ToString() != ce_nisira.CodUsuarioExiste) //if (dr.Cells[0].Value.ToString() != ce_rolesbi.CodExiste)
                    {
                        ...
                        objcnlog.GuardarDetalleCosechador(
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,//fecha
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//Empresa
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//Fundo
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//Cod_Cabezal
