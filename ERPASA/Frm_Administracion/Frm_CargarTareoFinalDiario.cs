...
{
    public partial class Frm_CargarTareoFinalDiario : Form
    {
        ...
        public Frm_CargarTareoFinalDiario()
        {
            InitializeComponent();
        }

        private void Frm_CargarTareoFinalDiario_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarTareoFinalDiario()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_administracion.EliminarTareoFinalDiario(
                        dateTimePicker_Fecha.Value.ToString() //Fecha
