...
{
    public partial class Frm_CargarProgramaRiego : Form
    {
        ...
        public Frm_CargarProgramaRiego()
        {
            InitializeComponent();
        }

        private void Frm_CargarProgramaRiego_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        private void toolStripButton_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count >= 1)
            {
                ...
                try
                {
                    if (comboBox_sede.Text == "SELECCIONE")
                    {
        ...
        public void GuardarProgramaRiego()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_administracion.BuscExisteProgramaRiego(
                        comboBox_sede.Text,
                        comboBox_cabezal.Text,
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date, //Fecha
                        dataGridView1[2, i].Value.ToString() //programa
                        );

                    if (exrev == true)
                    {
                        objcnlog.ActualizarProgramaRiego(
                        comboBox_sede.Text,//Empresa
                        comboBox_cabezal.Text,//Sede
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,//fecha
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//dia
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//programa
                        Convert.ToDateTime(dataGridView1[3, i].Value).Date,//tot horas
                        Convert.ToDecimal(dataGridView1[4, i].Value),//consumo m3
                        Convert.ToDecimal(dataGridView1[5, i].Value),//m3_ha
                        Convert.ToDecimal(dataGridView1[6, i].Value),//cub a
                        Convert.ToDecimal(dataGridView1[7, i].Value),//cuba b
                        Convert.ToDecimal(dataGridView1[8, i].Value),//cuba c
                        Convert.ToDecimal(dataGridView1[9, i].Value),//duba fito
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//observacion
