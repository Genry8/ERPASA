...
{
    public partial class Frm_CargarRiegoFertlizacion : Form
    {
        ...
        public Frm_CargarRiegoFertlizacion()
        {
            InitializeComponent();
        }

        private void Frm_CargarRiegoFertlizacion_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarFertilizacionRiego()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_administracion.BuscExisteFertilizacion(
                        comboBox_empresa.Text,
                        Convert.ToInt32(dataGridView1[0, i].Value), //Id
                        Convert.ToDateTime(dataGridView1[1, i].Value).Date //Fecha
                        );

                    if (exrev == true)
                    {
                        objcnlog.ActualizarFertilizacion(
                        comboBox_empresa.Text,
                        Convert.ToInt32(dataGridView1[0, i].Value), //Id
                        Convert.ToDateTime(dataGridView1[1, i].Value).Date, //Fecha
                        dataGridView1[2, i].Value.ToString(), //fenologia
                        dataGridView1[3, i].Value.ToString(), //Pulsos_Fertilizados
                        dataGridView1[4, i].Value.ToString(), //Pulsos_Riego
                        Convert.ToDecimal(dataGridView1[5, i].Value),//Horas
                        dataGridView1[6, i].Value.ToString(), //Variedad
                        dataGridView1[7, i].Value.ToString(), //Nombre_Comercial
                        dataGridView1[8, i].Value.ToString(), //Ing_Activo
                        Convert.ToDecimal(dataGridView1[9, i].Value),//Base_1000LT
                        Convert.ToInt32(dataGridView1[10, i].Value), //Inyeccion
                        dataGridView1[11, i].Value.ToString(), //Unidad
                        Convert.ToDecimal(dataGridView1[12, i].Value),//Qm3_Varidad
                        Convert.ToInt32(dataGridView1[13, i].Value), //Volumen_Teorico
                        Convert.ToDecimal(dataGridView1[14, i].Value),//KG_Teorico
                        Convert.ToDecimal(dataGridView1[15, i].Value),//Suma_Qm3_Total
                        Convert.ToInt32(dataGridView1[16, i].Value), //Vol_Sol_Lt_Reportado
                        Convert.ToInt32(dataGridView1[17, i].Value), //Vol
                        Convert.ToDecimal(dataGridView1[18, i].Value),//Cant
                        Convert.ToDecimal(dataGridView1[19, i].Value),//Efi_Inyeccion
                        Convert.ToDecimal(dataGridView1[20, i].Value),//Area
                        dataGridView1[21, i].Value.ToString(), //Valvula_Int
                        dataGridView1[22, i].Value.ToString(), //Tanque
                        dataGridView1[23, i].Value.ToString(), //Operador
