...
{
    public partial class Frm_CargarPersonalObservado : Form
    {
        ...
        public Frm_CargarPersonalObservado()
        {
            InitializeComponent();
        }

        private void Frm_CargarPersonalObservado_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarPersonalObservado()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_administracion.BuscExistePersonalObservado(
                    ...
                    {
                        objcnlog.GuardarPersonalObservado(
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,//fecha
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//dni
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//apenom
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim()//observacion
