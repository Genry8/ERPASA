...
{
    public partial class Frm_CargarEvaluacionCampo_SA : Form
    {
        ...
        public Frm_CargarEvaluacionCampo_SA()
        {
            InitializeComponent();
        }

        private void Frm_CargarEvaluacionCampo_SA_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarEvaluacionCampo()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_administracion.BuscExisteEvaluacionCampo(
                        ...
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//cabezal
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//cultivo
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//lote
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//grupo var
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim()//variable
                        );

                    if (exrev == true)
                    {
                        objcnlog.ActualizarEvaluacionCampo(
                        comboBox_empresa.Text,
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,//fecha
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//Sede
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//cabezal
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//cultivo
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//lote
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//muestra
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//grupo var
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//variable
                        Convert.ToInt32(dataGridView1[8, i].Value),//total
                        Convert.ToDecimal(dataGridView1[9, i].Value),//promedio
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//semaforo
                        Convert.ToDecimal(dataGridView1[11, i].Value),//severidad
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//semaforo 2
                        Convert.ToDecimal(dataGridView1[13, i].Value),//dispersion
                        dataGridView1[14, i].Value.ToString().ToUpper().Trim(),//fenologia
                        dataGridView1[15, i].Value.ToString().ToUpper().Trim(),//variedad
                    ...
                    {
                        objcnlog.GuardarEvaluacionCampo(
                        comboBox_empresa.Text,
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,//fecha
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//Sede
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//cabezal
