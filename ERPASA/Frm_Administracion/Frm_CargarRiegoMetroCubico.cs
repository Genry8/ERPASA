...
{
    public partial class Frm_CargarRiegoMetroCubico : Form
    {
        ...
        public Frm_CargarRiegoMetroCubico()
        {
            InitializeComponent();
        }

        private void Frm_CargarRiegoPercolacion_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarMetroCubico()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_administracion.BuscExisteMetroCubico(
                    ...
                    if (exrev == true)
                    {
                        objcnlog.ActualizarMetroCubico(
                        //comboBox_empresa.Text,//Empresa
                        comboBox_Sede.Text,//Sede
                        comboBox_cabezal.Text,//Sede
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,//fecha
                        Convert.ToDecimal(dataGridView1[1, i].Value),//
                        Convert.ToDecimal(dataGridView1[2, i].Value),//
                        Convert.ToDecimal(dataGridView1[3, i].Value),//
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim()//observacion
