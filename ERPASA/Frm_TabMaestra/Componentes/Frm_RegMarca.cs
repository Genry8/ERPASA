...
namespace ERPASA.Frm_TabMaestra
{
    public partial class Frm_RegMarca : Form
    {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarMarca frbm = new Frm_AgregarMarca();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaMarcaTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarMarca obj = new Frm_AgregarMarca();
            obj.textBox_CodMarca.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesMarca.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsMarca.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
