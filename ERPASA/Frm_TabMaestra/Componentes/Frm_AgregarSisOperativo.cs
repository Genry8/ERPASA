...
{
    public partial class Frm_AgregarSisOperativo : Form
    {
        ...
        public Frm_AgregarSisOperativo()
        {
            InitializeComponent();
        }
        ...
        private void Frm_AgregarSisOperativo_Load(object sender, EventArgs e)
        {
            if (textBox_CodSisOpe.Text == "")
            {
                CargarPanelgeneral();
                ...
                comboBox_SisOpe.DataSource = cn_regproducto.ListCond();
                comboBox_SisOpe.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
                comboBox_SisOpe.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR
            }
            BloquearTextboxCombobox();
        ...
        {
            textBox_DesSisOpe.Text = "";
            textbox_ObsSisOpe.Text = "";
        }

        public void BloquearTextboxCombobox()
        {
            textBox_CodSisOpe.Enabled = false;
            textBox_DesSisOpe.Enabled = false;
            textbox_ObsSisOpe.Enabled = false;
            comboBox_SisOpe.Enabled = false;
            comboBox_SisOpe.DropDownStyle = ComboBoxStyle.DropDownList;
        }

        public void DesbloquearTextboxCombobox()
        {
            textBox_DesSisOpe.Enabled = true;
            textbox_ObsSisOpe.Enabled = true;
            comboBox_SisOpe.Enabled = true;
            comboBox_SisOpe.DropDownStyle = ComboBoxStyle.DropDownList;
        }
        ...
        public void CargarPanelgeneral()
        {
            ...
            cn_logistica.BuscUltimoCodSisOperativoMas();
            if (ce_logistica.codigo.ToString() == "")
            {
                textBox_CodSisOpe.Text = "SO01";
            }
            else
            {
                textBox_CodSisOpe.Text = "SO" + ce_logistica.codigo.ToString("D2");
            }
            //LABEL            
            comboBox_SisOpe.DropDownStyle = ComboBoxStyle.DropDownList;
            textBox_DesSisOpe.CharacterCasing = CharacterCasing.Upper;
            textbox_ObsSisOpe.CharacterCasing = CharacterCasing.Upper;
            //
            //CARGAR CONDICION DEL PRODUCTO
            comboBox_SisOpe.DataSource = cn_regproducto.ListCond();
            comboBox_SisOpe.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
        ...
        private void Guardar()
        {
            if (textBox_DesSisOpe.Text != "")
            {
                ...
                cn_logistica.BuscExisteCodSisOperativo(textBox_CodSisOpe.Text);
                if (textBox_CodSisOpe.Text == ce_logistica.CodTiExist)
                {
                    ...
                    {
                        objdatlogisticaneg.ActuaSisOperativo(
                        textBox_CodSisOpe.Text,
                        textBox_DesSisOpe.Text,
                        textbox_ObsSisOpe.Text,
                        comboBox_SisOpe.SelectedValue.ToString(),
                        ...
                        Msbox.Frm_Notificaciones ng = new Msbox.Frm_Notificaciones("SIS OPERATIVO ACTUALIZADO", Color.FromArgb(13, 93, 140), 1);
                        ng.ShowDialog();
                        this.Close();
                ...
                else if (textBox_CodSisOpe.Text != ce_logistica.CodTiExist)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        objdatlogisticaneg.GuardSisOperativo(
                        textBox_CodSisOpe.Text,
                        textBox_DesSisOpe.Text,
                        textbox_ObsSisOpe.Text,
                        comboBox_SisOpe.SelectedValue.ToString(),
                        ...
                        Msbox.Frm_Notificaciones ng = new Msbox.Frm_Notificaciones("SIS OPERATIVO AGREGADO", Color.FromArgb(13, 93, 140), 1);
                        ng.ShowDialog();
                        this.Close();
                    }
                }
        ...
        private void Eliminar()
        {
            ...
            if (textBox_CodSisOpe.Text == ce_logistica.CodTiExist)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    objdatlogisticaneg.EliminSisOperativo(textBox_CodSisOpe.Text);
                    Msbox.Frm_Notificaciones ng = new Msbox.Frm_Notificaciones("SIS OPERATIVO ELIMINADO", Color.OrangeRed, 3);
                    ng.ShowDialog();
                    Close();
                    CargarPanelgeneral();
                    Limpiartextbox();
            ...
            {
                Msbox.Frm_Notificaciones ng = new Msbox.Frm_Notificaciones("SIS OPE NO ENCONTRADO", Color.OrangeRed, 3);
                ng.ShowDialog();
            }
        }
