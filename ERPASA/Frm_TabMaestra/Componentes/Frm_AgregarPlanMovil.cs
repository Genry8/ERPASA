...
{
    public partial class Frm_AgregarPlanMovil : Form
    {
        ...
        private void Frm_AgregarPlanMovil_Load(object sender, EventArgs e)
        {
            if (textBox_CodPlanMovil.Text == "")
            {
                CargarPanelgeneral();
                ...
                comboBox_EstPlanMovil.DataSource = cn_regproducto.ListCond();
                comboBox_EstPlanMovil.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
                comboBox_EstPlanMovil.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR
            }
            BloquearTextboxCombobox();
        ...
        public void ValidarSoloNumero()
        {
            bool ok = true;
            if (textBox_DesPlanMovil.Text == "")
            {
                ok = false;
                errorProv.SetError(textBox_DesPlanMovil, "Solo Número");
            }
        }

        public void Limpiartextbox()
        {
            textBox_DesPlanMovil.Text = "";
            textbox_ObsPlanMovil.Text = "";
        }

        public void BloquearTextboxCombobox()
        {
            textBox_CodPlanMovil.Enabled = false;
            textBox_DesPlanMovil.Enabled = false;
            textbox_ObsPlanMovil.Enabled = false;
            comboBox_EstPlanMovil.Enabled = false;
            comboBox_EstPlanMovil.DropDownStyle = ComboBoxStyle.DropDownList;
        }

        public void DesbloquearTextboxCombobox()
        {
            textBox_DesPlanMovil.Enabled = true;
            textbox_ObsPlanMovil.Enabled = true;
            comboBox_EstPlanMovil.Enabled = true;
            comboBox_EstPlanMovil.DropDownStyle = ComboBoxStyle.DropDownList;
        }
        ...
        public void CargarPanelgeneral()
        {
            ...
            cn_logistica.BuscUltimoCodPlanMovilTIMas();
            if (ce_logistica.codigo.ToString() == "")
            {
                textBox_CodPlanMovil.Text = "PL01";
            }
            else
            {
                textBox_CodPlanMovil.Text = "PL" + ce_logistica.codigo.ToString("D2");
            }
            //LABEL            
            comboBox_EstPlanMovil.DropDownStyle = ComboBoxStyle.DropDownList;
            textBox_DesPlanMovil.CharacterCasing = CharacterCasing.Upper;
            textbox_ObsPlanMovil.CharacterCasing = CharacterCasing.Upper;
            //
            //CARGAR CONDICION DEL PRODUCTO
            comboBox_EstPlanMovil.DataSource = cn_regproducto.ListCond();
            comboBox_EstPlanMovil.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
        ...
        private void Guardar()
        {
            if (textBox_DesPlanMovil.Text != "")
            {
                ...
                cn_logistica.BuscExisteCodPlanMovilTI(textBox_CodPlanMovil.Text);
                if (textBox_CodPlanMovil.Text == ce_logistica.CodTiExist)
                {
                    ...
                    {
                        objdatlogisticaneg.ActuaPlanMovilTI(
                        textBox_CodPlanMovil.Text,
                        textBox_DesPlanMovil.Text,
                        textbox_ObsPlanMovil.Text,
                        comboBox_EstPlanMovil.SelectedValue.ToString(),
                ...
                else if (textBox_CodPlanMovil.Text != ce_logistica.CodTiExist)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        objdatlogisticaneg.GuardPlanMovilTI(
                        textBox_CodPlanMovil.Text,
                        textBox_DesPlanMovil.Text,
                        textbox_ObsPlanMovil.Text,
                        comboBox_EstPlanMovil.SelectedValue.ToString(),
        ...
        private void Eliminar()
        {
            ...
            if (textBox_CodPlanMovil.Text == ce_logistica.CodTiExist)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    objdatlogisticaneg.EliminPlanMovilTI(textBox_CodPlanMovil.Text);
            ...
            {
                Msbox.Frm_Notificaciones ng = new Msbox.Frm_Notificaciones("TIPO NO ENCONTRADO", Color.OrangeRed, 3);
                ng.ShowDialog();
            }
        }
        ...
        private void textBox_DesPlanMovil_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void textBox_DesPlanMovil_Click(object sender, EventArgs e)
        {
            //ValidarSoloNumero();
        }
    }
