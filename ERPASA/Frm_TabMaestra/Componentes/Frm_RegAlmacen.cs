...
{
    public partial class Frm_RegAlmacen : Form
    {
        ...
        private void Frm_RegAlmacen_Load(object sender, EventArgs e)
        {
        ...
        private void ColumnasDtgv()
        {
            ...
            // Column2
            // 
            DataGridViewTextBoxColumn Almacen = new DataGridViewTextBoxColumn();
            Almacen.HeaderText = "Almacen";
            Almacen.Name = "Column2";
            Almacen.Width = 87;
            dataGridView2.Columns.Add(Almacen);
        ...
        {
            //cn_logistica.BuscUltimoCodGrupoMas();
            ce_logistica.codigo_ti = "";
            ce_logistica.descripcion_ti = "";
            ce_logistica.comentario_ti = "";
            ce_logistica.estado_ti = "S";
            ce_logistica.establecimiento = "1";

            Frm_AgregarAlmacen frbm = new Frm_AgregarAlmacen();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaAlmacenProd();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ce_logistica.establecimiento = dataGridView2.CurrentRow.Cells[4].Value.ToString();

            Frm_AgregarAlmacen obj = new Frm_AgregarAlmacen();
            obj.ShowDialog();
        }
        ...
        public void OrigenColorfila()
        {
            ...
            for (int i = 0; i < c; i++)
            {
                if (dataGridView2.Rows[i].Cells[3].Value.ToString() == "N")
                {
