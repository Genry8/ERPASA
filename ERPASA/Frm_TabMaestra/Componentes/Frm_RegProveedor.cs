...
{
    public partial class Frm_RegProveedor : Form
    {
        ...
        private void Frm_RegProveedor_Load(object sender, EventArgs e)
        {
        ...
        public void CargarPanelgeneral()
        {
            ...
            //toolStripButton_nuevo.Enabled = false;
            //LABEL            
            ColumnasDtgv();
        }
        ...
        private void ColumnasDtgv()
        {
            ...
            Ruc.Name = "Column4";
            Ruc.Width = 73;
            dataGridView2.Columns.Add(Ruc);
            // 
            // Column5
            // 
            DataGridViewTextBoxColumn Direccion = new DataGridViewTextBoxColumn();
            Direccion.HeaderText = "Dirección";
            Direccion.Name = "Column5";
            Direccion.Width = 73;
            dataGridView2.Columns.Add(Direccion);
            // 
            // Column6
            // 
            DataGridViewTextBoxColumn Telefono = new DataGridViewTextBoxColumn();
            Telefono.HeaderText = "Telefono";
            Telefono.Name = "Column6";
            Telefono.Width = 73;
            dataGridView2.Columns.Add(Telefono);
            // 
            // Column7
            // 
            ...
            // Column8
            // 
            DataGridViewTextBoxColumn Ubigeo = new DataGridViewTextBoxColumn();
            Ubigeo.HeaderText = "Ubigeo";
            Ubigeo.Name = "Column8";
            Ubigeo.Width = 73;
            dataGridView2.Columns.Add(Ubigeo);
        ...
        {
            cn_logistica.BuscUltimoCodProvMas();
            ce_logistica.codigo_ti = ce_logistica.codigo.ToString();
            ce_logistica.descripcion_ti = "";
            ce_logistica.comentario_ti = "";
            ce_logistica.ruc_ti = "";
            ce_logistica.dirección_ti = "";
            ce_logistica.telefono_ti = "";
            ce_logistica.estado_ti = "AC";
            ce_logistica.establecimiento = "000000";

            Frm_AgregarProveedor frbm = new Frm_AgregarProveedor();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaProveedorProd();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //ce_logistica.ruc_ti = dataGridView2.CurrentRow.Cells[3].Value.ToString();
            //ce_logistica.dirección_ti = dataGridView2.CurrentRow.Cells[4].Value.ToString();
            //ce_logistica.telefono_ti = dataGridView2.CurrentRow.Cells[5].Value.ToString();
            //ce_logistica.estado_ti = dataGridView2.CurrentRow.Cells[6].Value.ToString();
            //ce_logistica.establecimiento = dataGridView2.CurrentRow.Cells[7].Value.ToString();

            Frm_AgregarProveedor obj = new Frm_AgregarProveedor();
            obj.textBox_CodProveedor.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_descripcion.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_comentario.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
            obj.textBox_Ruc.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
            obj.textBox_Dirección.Text = dataGridView2.CurrentRow.Cells[4].Value.ToString();
            obj.textBox_Telefono.Text = dataGridView2.CurrentRow.Cells[5].Value.ToString();
            ...
            //CARGAR UBIGEO
            obj.comboBox_Distrito.DataSource = cn_datospersonal.ListUbigeo();
            obj.comboBox_Distrito.DisplayMember = "ubides"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            obj.comboBox_Distrito.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            obj.comboBox_estado.Text = dataGridView2.CurrentRow.Cells[6].Value.ToString();
            obj.comboBox_Distrito.Text = dataGridView2.CurrentRow.Cells[7].Value.ToString();
