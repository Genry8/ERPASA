...
{
    public partial class Frm_RegOrigenActivo : Form
    {
        ...
        private void Frm_RegOrigenActivo_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarOrigenActivo frbm = new Frm_AgregarOrigenActivo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaOrigenActTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarOrigenActivo obj = new Frm_AgregarOrigenActivo();
            obj.textBox_CodOrigenActivo.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesOrigen.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsOrigen.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
            ...
            obj.comboBox_Estado.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
