...
{
    public partial class Frm_RegEstadoActivo : Form
    {
        ...
        private void Frm_RegEstadoActivo_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarEstadoActivo frbm = new Frm_AgregarEstadoActivo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaEstActivoTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarEstadoActivo obj = new Frm_AgregarEstadoActivo();
            obj.textBox_CodEstAct.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesEstAct.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsEstAct.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
