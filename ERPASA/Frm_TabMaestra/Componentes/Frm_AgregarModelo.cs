...
{
    public partial class Frm_AgregarModelo : Form
    {
        ...
        private void Frm_AgregarModelo_Load(object sender, EventArgs e)
        {
            if (textBox_CodModelo.Text == "")
            {
                CargarPanelgeneral();
        ...
        {
            textBox_DesModelo.Text = "";
            textbox_ObsModelo.Text = "";
        }

        public void BloquearTextboxCombobox()
        {
            textBox_CodModelo.Enabled = false;
            textBox_DesModelo.Enabled = false;
            textbox_ObsModelo.Enabled = false;
        ...
        {
            textBox_DesModelo.Enabled = true;
            textbox_ObsModelo.Enabled = true;
        ...
        public void CargarPanelgeneral()
        {
            ...
            cn_logistica.BuscUltimoCodModeloTIMas();
            if (ce_logistica.codigo.ToString() == "")
            {
                textBox_CodModelo.Text = "MD001";
            }
            else
            {
                textBox_CodModelo.Text = "MD" + ce_logistica.codigo.ToString("D3");
            }
            //LABEL            
            comboBox_Est.DropDownStyle = ComboBoxStyle.DropDownList;
            textBox_DesModelo.CharacterCasing = CharacterCasing.Upper;
            textbox_ObsModelo.CharacterCasing = CharacterCasing.Upper;
            //
            //CARGAR CONDICION DEL PRODUCTO
            comboBox_Est.DataSource = cn_regproducto.ListCond();
            comboBox_Est.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
        ...
        private void Guardar()
        {
            if (textBox_DesModelo.Text != "")
            {
                ...
                cn_logistica.BuscExisteCodModeloTI(textBox_CodModelo.Text);
                if (textBox_CodModelo.Text == ce_logistica.CodTiExist)
                {
                    ...
                    {
                        objdatlogisticaneg.ActuaModeloTI(
                        textBox_CodModelo.Text,
                        textBox_DesModelo.Text,
                        textbox_ObsModelo.Text,
                ...
                else if (textBox_CodModelo.Text != ce_logistica.CodTiExist)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        objdatlogisticaneg.GuardModeloTI(
                        textBox_CodModelo.Text,
                        textBox_DesModelo.Text,
                        textbox_ObsModelo.Text,
                        comboBox_Est.SelectedValue.ToString(),
        ...
        private void Eliminar()
        {
            ...
            if (textBox_CodModelo.Text == ce_logistica.CodTiExist)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    objdatlogisticaneg.EliminModeloTI(textBox_CodModelo.Text);
