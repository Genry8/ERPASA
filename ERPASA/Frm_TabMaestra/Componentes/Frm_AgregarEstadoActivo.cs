...
{
    public partial class Frm_AgregarEstadoActivo : Form
    {
        ...
        public Frm_AgregarEstadoActivo()
        {
            InitializeComponent();
        }
        ...
        private void Frm_AgregarEstadoActivo_Load(object sender, EventArgs e)
        {
            if (textBox_CodEstAct.Text == "")
            {
                CargarPanelgeneral();
        ...
        {
            textBox_DesEstAct.Text = "";
            textbox_ObsEstAct.Text = "";
        }

        public void BloquearTextboxCombobox()
        {
            textBox_CodEstAct.Enabled = false;
            textBox_DesEstAct.Enabled = false;
            textbox_ObsEstAct.Enabled = false;
        ...
        {
            textBox_DesEstAct.Enabled = true;
            textbox_ObsEstAct.Enabled = true;
        ...
        public void CargarPanelgeneral()
        {
            ...
            cn_logistica.BuscUltimoCodEstActivoMas();
            if (ce_logistica.codigo.ToString() == "")
            {
                textBox_CodEstAct.Text = "EA01";
            }
            else
            {
                textBox_CodEstAct.Text = "EA" + ce_logistica.codigo.ToString("D2");
            }
            //LABEL            
            comboBox_Est.DropDownStyle = ComboBoxStyle.DropDownList;
            textBox_DesEstAct.CharacterCasing = CharacterCasing.Upper;
            textbox_ObsEstAct.CharacterCasing = CharacterCasing.Upper;
            //
            //CARGAR CONDICION DEL PRODUCTO
            comboBox_Est.DataSource = cn_regproducto.ListCond();
            comboBox_Est.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
        ...
        private void Guardar()
        {
            if (textBox_DesEstAct.Text != "")
            {
                ...
                cn_logistica.BuscExisteCodEstActivo(textBox_CodEstAct.Text);
                if (textBox_CodEstAct.Text == ce_logistica.CodTiExist)
                {
                    ...
                    {
                        objdatlogisticaneg.ActuaEstActivo(
                        textBox_CodEstAct.Text,
                        textBox_DesEstAct.Text,
                        textbox_ObsEstAct.Text,
                ...
                else if (textBox_CodEstAct.Text != ce_logistica.CodTiExist)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        objdatlogisticaneg.GuardEstActivo(
                        textBox_CodEstAct.Text,
                        textBox_DesEstAct.Text,
                        textbox_ObsEstAct.Text,
                        comboBox_Est.SelectedValue.ToString(),
        ...
        private void Eliminar()
        {
            ...
            if (textBox_CodEstAct.Text == ce_logistica.CodTiExist)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    objdatlogisticaneg.EliminEstActivo(textBox_CodEstAct.Text);
