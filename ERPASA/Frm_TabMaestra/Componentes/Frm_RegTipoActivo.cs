...
{
    public partial class Frm_RegTipoActivo : Form
    {
        ...
        private void Frm_RegTipoActivo_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarTipoActivo frbm = new Frm_AgregarTipoActivo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaTipoActivoTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarTipoActivo obj = new Frm_AgregarTipoActivo();
            obj.textBox_CodTipAct.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesTipo.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsTipAct.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
            ...
            obj.comboBox_EstSede.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
