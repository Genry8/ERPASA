...
{
    public partial class Frm_RegPlanMovil : Form
    {
        ...
        private void Frm_RegPlanMovil_Load(object sender, EventArgs e)
        {
        ...
        private void ColumnasDtgv()
        {
            ...
            Plan.Name = "Column2";
            Plan.Width = 87;
            dataGridView2.Columns.Add(Plan);
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarPlanMovil frbm = new Frm_AgregarPlanMovil();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaPlanMovilTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarPlanMovil obj = new Frm_AgregarPlanMovil();
            obj.textBox_CodPlanMovil.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesPlanMovil.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsPlanMovil.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();

            //CARGAR CONDICION DEL PRODUCTO
            obj.comboBox_EstPlanMovil.DataSource = cn_regproducto.ListCond();
            obj.comboBox_EstPlanMovil.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            obj.comboBox_EstPlanMovil.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            obj.comboBox_EstPlanMovil.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
            ...
            if (obj.comboBox_EstPlanMovil.Text == "ANULADO")
            {
