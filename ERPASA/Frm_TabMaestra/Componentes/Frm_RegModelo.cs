...
{
    public partial class Frm_RegModelo : Form
    {
        ...
        private void Frm_RegModelo_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarModelo frbm = new Frm_AgregarModelo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaModeloTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarModelo obj = new Frm_AgregarModelo();
            obj.textBox_CodModelo.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesModelo.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsModelo.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
