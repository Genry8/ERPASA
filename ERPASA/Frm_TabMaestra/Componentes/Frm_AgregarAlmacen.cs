...
{
    public partial class Frm_AgregarAlmacen : Form
    {
        ...
        private void Frm_AgregarAlmacen_Load(object sender, EventArgs e)
        {
            CargarPanelgeneral();
            BloquearTextboxCombobox();
            //BloquearTextboxCombobox();

            textBox_CodAlmacen.Text = ce_logistica.codigo_ti.ToString();
            ...
            comboBox_Establecimiento.SelectedValue = ce_logistica.establecimiento;
        ...
        {
            textBox_CodAlmacen.Enabled = false;
        ...
        {
            textBox_CodAlmacen.Enabled = true;
        ...
        public void CargarPanelgeneral()
        {
            ...
            if (ce_logistica.codigo_ti.ToString() == "")
            {
            ...
            comboBox_estado.DataSource = cn_regproducto.ListCondAlm();
            comboBox_estado.DisplayMember = "AlmCondicionDes"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
        ...
        private void GuardarMarca()
        {
            if (textBox_descripcion.Text != "")
            {
                ...
                {
                    cn_logistica.BuscExisteCodAlm(textBox_CodAlmacen.Text);
                    if (textBox_CodAlmacen.Text == ce_logistica.CodTiExist)
                    {
                    ...
                    else if (textBox_CodAlmacen.Text != ce_logistica.CodTiExist)
                    {
        ...
        private void EliminarGrupo()
        {
            ...
            if (textBox_CodAlmacen.Text == ce_logistica.CodTiExist)
            {
                ...
                string MessageBoxContent = "¿Desea eliminar Almacen?";

                DialogResult dialogResult = MessageBox.Show(MessageBoxContent, MessageBoxTitle, MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                if (dialogResult == DialogResult.Yes)
                {
                    objdatlogisticaneg.EliminAlm(textBox_CodAlmacen.Text);
                    Msbox.Frm_Notificaciones ng = new Msbox.Frm_Notificaciones("ALMACEN ELIMINADO", Color.OrangeRed, 3);
                    ng.ShowDialog();
                    Close();
                    CargarPanelgeneral();
                    Limpiartextbox();
            ...
            {
                Msbox.Frm_Notificaciones ng = new Msbox.Frm_Notificaciones("ALMACEN NO ENCONTRADO", Color.OrangeRed, 3);
                ng.ShowDialog();
            }
        }
