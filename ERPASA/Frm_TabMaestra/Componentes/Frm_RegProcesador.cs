...
{
    public partial class Frm_RegProcesador : Form
    {
        ...
        private void Frm_RegProcesador_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarProcesador frbm = new Frm_AgregarProcesador();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaProcesadorTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarProcesador obj = new Frm_AgregarProcesador();
            obj.textBox_CodProcesador.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesProcesador.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsProcesador.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
            ...
            obj.comboBox_Est.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
