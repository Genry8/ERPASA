...
{
    public partial class Frm_RegSisOperativo : Form
    {
        ...
        private void Frm_RegSisOperativo_Load(object sender, EventArgs e)
        {
        ...
        private void ColumnasDtgv()
        {
            ...
            Color.HeaderText = "Sis Operativo";
            Color.Name = "Column2";
            Color.Width = 87;
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarSisOperativo frbm = new Frm_AgregarSisOperativo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaSisOperativoTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarSisOperativo obj = new Frm_AgregarSisOperativo();
            obj.textBox_CodSisOpe.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesSisOpe.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsSisOpe.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();

            //CARGAR CONDICION DEL PRODUCTO
            obj.comboBox_SisOpe.DataSource = cn_regproducto.ListCond();
            obj.comboBox_SisOpe.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            obj.comboBox_SisOpe.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            obj.comboBox_SisOpe.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
            ...
            if (obj.comboBox_SisOpe.Text == "ANULADO")
            {
