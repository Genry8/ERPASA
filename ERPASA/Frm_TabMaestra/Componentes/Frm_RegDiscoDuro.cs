...
{
    public partial class Frm_RegDiscoDuro : Form
    {
        ...
        private void Frm_RegDiscoDuro_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarDiscoDuro frbm = new Frm_AgregarDiscoDuro();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaDiscoDuroTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarDiscoDuro obj = new Frm_AgregarDiscoDuro();
            obj.textBox_CodDD.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesDD.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsDD.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
