...
{
    public partial class Frm_RegMemoria : Form
    {
        ...
        private void Frm_RegMemoria_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarMemoria frbm = new Frm_AgregarMemoria();
            AddOwnedForm(frbm);
            frbm.ShowDialog();

            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaMemoriaTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarMemoria obj = new Frm_AgregarMemoria();
            obj.textBox_CodMemoria.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesMemoria.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsMemoria.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();

            //CARGAR CONDICION DEL PRODUCTO
            obj.comboBox_Memoria.DataSource = cn_regproducto.ListCond();
            obj.comboBox_Memoria.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            obj.comboBox_Memoria.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            obj.comboBox_Memoria.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
            ...
            if (obj.comboBox_Memoria.Text == "ANULADO")
            {
