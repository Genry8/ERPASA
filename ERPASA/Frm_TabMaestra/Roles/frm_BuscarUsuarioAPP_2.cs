...
namespace ERPASA.Frm_TabMaestra
{
    ...
    public partial class frm_BuscarUsuarioAPP_2 : Form
    {
        ...
        public frm_BuscarUsuarioAPP_2()
        {
            InitializeComponent();
            //FormBorderStyle = FormBorderStyle.None;            
        }

        private void frm_BuscarUsuarioAPP_2_Load(object sender, EventArgs e)
        {
            comboBox_TipoUsuarioAPP.SelectedIndex = 0;
            comboBox_TipoUsuarioAPP.DropDownStyle = ComboBoxStyle.DropDownList;
            textbox_DescUsuarioAPP.Focus();

            textbox_DescUsuarioAPP.CharacterCasing = CharacterCasing.Upper;
        ...
        private void dataGridView2_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            else
            {
                ...
                /////////
                VarDatosEntroFormUsuarioAP var1 = Owner as VarDatosEntroFormUsuarioAP;
                DataGridViewRow fila = dataGridView2.SelectedRows[0] as DataGridViewRow;
                var1.TablaAgregarDatosFilaAsigD2(fila);
                this.Close();
        ...
        private void textbox_ActivoDesc_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                if (comboBox_TipoUsuarioAPP.Text == "APELLIDOS Y NOMBRES")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_rolesuser.ListaBuscarUsuarioAPP("%", textbox_DescUsuarioAPP.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    //OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
                if (comboBox_TipoUsuarioAPP.Text == "DNI")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_rolesuser.ListaBuscarUsuarioAPP(textbox_DescUsuarioAPP.Text, "%");
                    dataGridView2.AllowUserToAddRows = false;
