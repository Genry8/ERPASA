...
{
    public partial class Frm_RegaArea : Form
    {
        ...
        private void Frm_RegaArea_Load(object sender, EventArgs e)
        {
        ...
        public void CargarPanelgeneral()
        {
            ...
            //
            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaAreaTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarArea frbm = new Frm_AgregarArea();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarArea obj = new Frm_AgregarArea();
            obj.textBox_CodArea.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesArea.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            // CARGAR GERENCIA
            obj.comboBox_Gerencia.DataSource = cn_logistica.ListaGerencia();
            obj.comboBox_Gerencia.DisplayMember = "DesGer"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            obj.comboBox_Gerencia.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            obj.comboBox_Gerencia.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
            obj.textbox_ObsArea.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();

            //CARGAR CONDICION DEL PRODUCTO
            obj.comboBox_EstArea.DataSource = cn_regproducto.ListCond();
            obj.comboBox_EstArea.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            obj.comboBox_EstArea.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            obj.comboBox_EstArea.Text = dataGridView2.CurrentRow.Cells[4].Value.ToString();
            ...
            if (obj.comboBox_EstArea.Text == "ANULADO")
            {
