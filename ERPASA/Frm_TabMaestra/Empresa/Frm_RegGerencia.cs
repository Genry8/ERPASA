...
{
    public partial class Frm_RegGerencia : Form
    {
        ...
        private void Frm_RegGerencia_Load(object sender, EventArgs e)
        {
        ...
        public void CargarPanelgeneral()
        {
            ...
            //
            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaGerenciaTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarGerencia frbm = new Frm_AgregarGerencia();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarGerencia obj = new Frm_AgregarGerencia();
            obj.textBox_CodGerencia.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesGerencia.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsGerencia.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();

            //CARGAR CONDICION DEL PRODUCTO
            obj.comboBox_EstGerencia.DataSource = cn_regproducto.ListCond();
            obj.comboBox_EstGerencia.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            obj.comboBox_EstGerencia.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            obj.comboBox_EstGerencia.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
            ...
            if (obj.comboBox_EstGerencia.Text == "ANULADO")
            {
