...
{
    public partial class Frm_RegEmpresa : Form
    {
        ...
        private void Frm_RegEmpresa_Load(object sender, EventArgs e)
        {
        ...
        public void CargarPanelgeneral()
        {
            ...
            //
            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_logistica.ListaEmpresaTI();
            dataGridView2.AllowUserToAddRows = false;
            OrigenColorfila();
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarEmpresa frbm = new Frm_AgregarEmpresa();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarEmpresa obj = new Frm_AgregarEmpresa();
            obj.textBox_CodEmpresa.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesEmpresa.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textbox_ObsEmpresa.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
            //obj.comboBox_EstEmpresa.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();

            //CARGAR CONDICION DEL PRODUCTO
            obj.comboBox_EstEmpresa.DataSource = cn_regproducto.ListCond();
            obj.comboBox_EstEmpresa.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            obj.comboBox_EstEmpresa.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR

            obj.comboBox_EstEmpresa.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
            ...
            if (obj.comboBox_EstEmpresa.Text == "ANULADO")
            {
