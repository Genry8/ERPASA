...
{
    public partial class Frm_AgregarPeriferico : Form
    {
        ...
        private void Frm_AgregarPeriferico_Load(object sender, EventArgs e)
        {
        ...
        private void Guardar()
        {
            if (textBox_DesPer.Text != "")
            {
                ...
                if (textBox_CodPer.Text == ce_logistica.CodTiExist)
                {
                    ...
                    {
                        objdatlogisticaneg.ActuaPerifericoTI(
                        textBox_CodPer.Text,
                        textBox_DesPer.Text,
                        textBox_DesPerSerie.Text,
                        textBox_DesPerIMEI.Text,
                ...
                else if (textBox_CodPer.Text != ce_logistica.CodTiExist)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        objdatlogisticaneg.GuardPerifericoTI(
                        textBox_CodPer.Text,
                        textBox_DesPer.Text,
                        textBox_DesPerSerie.Text,
                        textBox_DesPerIMEI.Text,
        ...
        private void textBox_DesPerSerie_TextChanged(object sender, EventArgs e)
        {
            QrEncoder qrEncoder = new QrEncoder(ErrorCorrectionLevel.H);
            QrCode QRCode = new QrCode();
            qrEncoder.TryEncode(textBox_DesPerSerie.Text.Trim(), out QRCode);
            ...
            pictureBox_Periferico_QR.BackgroundImage = imagen;
