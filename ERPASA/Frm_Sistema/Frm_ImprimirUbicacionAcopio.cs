...
{
    public partial class Frm_ImprimirUbicacionAcopio : Form
    {
        ...
        public Frm_ImprimirUbicacionAcopio()
        {
            InitializeComponent();
        }

        private void Frm_ImprimirUbicacionAcopio_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
        ...
        public void ImprimirFotosheckCampamento()
        {
            ...
            DataSetSistemas objDsRepFotosheck = new DataSetSistemas();
            ...
            for (int i = 0; i <= filas - 1; i++)
            {
                objDsRepFotosheck.Tables[0].Rows.Add
                    (new object[]{
                    dataGridView1[0,i].Value.ToString().ToUpper(),//TITULO
                    dataGridView1[1,i].Value.ToString().ToUpper(),//UBICACION
                    dataGridView1[2,i].Value.ToString().ToUpper()//PIE
            ...
            Frm_Sistema.CrystalReportPrinUbic objCryRep = new Frm_Sistema.CrystalReportPrinUbic();
            //string dir = @"~\CryRep_VentasUsuario.rpt";
            objCryRep.Load(@"~\CrystalReportPrinUbic.rpt");
