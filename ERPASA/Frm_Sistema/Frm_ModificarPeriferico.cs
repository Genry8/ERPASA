...
{
    public partial class Frm_ModificarPeriferico : Form
    {
        ...
        public Frm_ModificarPeriferico()
        {
            InitializeComponent();
        }
        ...
        private void Frm_ModificarPeriferico_Load(object sender, EventArgs e)
        {
            if (textBox_CodPer.Text == "")
            {
                CargarPanelgeneral();
        ...
        public void Limpiartextbox()
        {
            textBox_DesPer.Text = "";
            textbox_ObsPer.Text = "";
            textBox_DesPerSerie.Text = "";
            textBox_DesPerIMEI.Text = "";
            textBox_DesPerMod.Text = "";
        }

        public void BloquearTextboxCombobox()
        {
            textBox_CodPer.Enabled = false;
            textBox_DesPer.Enabled = false;
            textbox_ObsPer.Enabled = false;
            textBox_DesPerSerie.Enabled = false;
            textBox_DesPerIMEI.Enabled = false;
            textBox_DesPerMod.Enabled = false;
        ...
        {
            //textBox_DesPer.Enabled = true;
            //textbox_ObsPer.Enabled = true;
            //textBox_DesPerSerie.Enabled = true;
            //textBox_DesPerIMEI.Enabled = true;
            //textBox_DesPerMod.Enabled = true;
        ...
        public void CargarPanelgeneral()
        {
            ...
            if (textBox_DesPer.Text == "")
            {
                toolStripButton_guardar_edtiper.Enabled = false;
                toolStripButton_editar_editper.Enabled = false;
                toolStripButton_eliminar_edit_per.Enabled = false;
            }

            //LLAMAR EN TEXBOX AL ULTIMO CODIGO DE MARCA +1 
            cn_logistica.BuscUltimoCodPerifericoTIMas();
            if (ce_logistica.codigo.ToString() == "")
            {
                textBox_CodPer.Text = "PR0001";
            }
            else
            {
                textBox_CodPer.Text = "PR" + ce_logistica.codigo.ToString("D4");
            }
            //LABEL            
            comboBox_Est.DropDownStyle = ComboBoxStyle.DropDownList;
            textBox_DesPer.CharacterCasing = CharacterCasing.Upper;
            textbox_ObsPer.CharacterCasing = CharacterCasing.Upper;
            textBox_DesPerSerie.CharacterCasing = CharacterCasing.Upper;
            textBox_DesPerIMEI.CharacterCasing = CharacterCasing.Upper;
            textBox_DesPerMod.CharacterCasing = CharacterCasing.Upper;
            //
            //CARGAR CONDICION DEL PRODUCTO
            comboBox_Est.DataSource = cn_regproducto.ListCond();
            comboBox_Est.DisplayMember = "DesEstado"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            toolStripButton_guardar_edtiper.Enabled = true;
            textBox_DesPer.Focus();
        }
        ...
        {
            //cn_logistica.BuscExisteCodPerifericoTI(textBox_CodPer.Text);
            //if (textBox_CodPer.Text == ce_logistica.CodTiExist)
            //{
            ...
            //    {
            //        objdatlogisticaneg.EliminPerifericoTI(textBox_CodPer.Text);
        ...
        {
            cn_logistica.BuscExisteCodActivoPerEstTI(ce_logistica.CodActTI, textBox_CodPer.Text);
            if (ce_logistica.CodActTI == ce_logistica.CodTiExist
                && textBox_CodPer.Text == ce_logistica.codperTI)
            {
                objdatlogisticaneg.ActuaActPerifericoTI(
                    ce_logistica.CodActTI,
                    textBox_CodPer.Text,
                    //textBox_DesPerSerie.Text,
                    //textBox_DesPerIMEI.Text,
                    //textBox_DesPerMod.Text,
