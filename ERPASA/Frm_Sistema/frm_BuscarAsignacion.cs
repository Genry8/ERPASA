...
namespace ERPASA.Frm_Sistema
{
    ...
    public partial class frm_BuscarAsignacion : Form
    {
        ...
        public frm_BuscarAsignacion()
        {
            InitializeComponent();
            //FormBorderStyle = FormBorderStyle.None;            
        }

        private void frm_BuscarAsignacion_Load(object sender, EventArgs e)
        {
            comboBox_TiposAsig.SelectedIndex = 0;
            comboBox_TiposAsig.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        private void dataGridView2_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (dataGridView2.CurrentRow.Cells[12].Value.ToString() == "EN USO")
            {
            ...
            else
            {
                ...
                /////////
                VarDatosEntroFormBPA var1 = Owner as VarDatosEntroFormBPA;
        ...
        public void OrigenColorfila()
        {
            ...
            for (int i = 0; i < c; i++)
            {
                if (dataGridView2.Rows[i].Cells[11].Value.ToString() == "ANULADO")
                {
        ...
        private void textbox_ActivoDesc_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                if (comboBox_TiposAsig.Text == "ACTIVO")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionFiltroTI(textbox_ActivoDesc.Text,
                        "%", "%", "%", "%", "%", "%");
                    dataGridView2.AllowUserToAddRows = false;
                    OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
                if (comboBox_TiposAsig.Text == "MARCA")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionFiltroTI("%",
                ...
                if (comboBox_TiposAsig.Text == "MODELO")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionFiltroTI("%",
                        "%", textbox_ActivoDesc.Text, "%", "%", "%", "%");
                ...
                if (comboBox_TiposAsig.Text == "SERIE")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionFiltroTI("%",
                        "%", "%", textbox_ActivoDesc.Text, "%", "%", "%");
                ...
                if (comboBox_TiposAsig.Text == "IMEI")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionFiltroTI("%",
                        "%", "%", "%", textbox_ActivoDesc.Text, "%", "%");
                ...
                if (comboBox_TiposAsig.Text == "MAC ETHERNET")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionFiltroTI("%",
                        "%", "%", "%", "%", textbox_ActivoDesc.Text, "%");
                ...
                if (comboBox_TiposAsig.Text == "MAC WIFI")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionFiltroTI("%",
                        "%", "%", "%", "%", "%", textbox_ActivoDesc.Text);
