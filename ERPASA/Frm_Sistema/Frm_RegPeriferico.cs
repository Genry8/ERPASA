...
{
    public partial class Frm_RegPeriferico : Form
    {
        ...
        private void Frm_RegPeriferico_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            Frm_AgregarPeriferico frbm = new Frm_AgregarPeriferico();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Frm_AgregarPeriferico obj = new Frm_AgregarPeriferico();
            obj.textBox_CodPer.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
            obj.textBox_DesPer.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
            obj.textBox_DesPerSerie.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
            obj.textBox_DesPerIMEI.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
            obj.textBox_DesPerMod.Text = dataGridView2.CurrentRow.Cells[4].Value.ToString();
            obj.textbox_ObsPer.Text = dataGridView2.CurrentRow.Cells[5].Value.ToString();
            ...
            obj.comboBox_Est.Text = dataGridView2.CurrentRow.Cells[6].Value.ToString();
