...
namespace ERPASA.Frm_Sistema
{
    ...
    public partial class frm_BuscarAsigAct : Form
    {
        ...
        public frm_BuscarAsigAct()
        {
            InitializeComponent();
            //FormBorderStyle = FormBorderStyle.None;            
        }

        private void frm_BuscarAsigAct_Load(object sender, EventArgs e)
        {
            ...
            dataGridView2.DataSource = cn_logistica.ListaAsignacionBuscTI();
        ...
        private void dataGridView2_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (dataGridView2.CurrentRow.Cells[10].Value.ToString() == "ANULADO")
            {
            ...
            else
            {
                ...
                cn_logistica.BuscExisteCodActivoPerTI(ce_logistica.CodActTI, dataGridView2.CurrentRow.Cells[0].Value.ToString());
                if (ce_logistica.CodActTI == ce_logistica.CodTiExist
                    && dataGridView2.CurrentRow.Cells[0].Value.ToString() == ce_logistica.codperTI)
                {
                    //Msbox.Frm_Notificaciones ng = new Msbox.Frm_Notificaciones("YA FUE AÑADIDO", Color.Red, 3);
                    //ng.ShowDialog();
                }

                else if (ce_logistica.CodActTI == ce_logistica.CodTiExist
                    && dataGridView2.CurrentRow.Cells[0].Value.ToString() != ce_logistica.codperTI)
                {
        ...
        private void textbox_ActivoDesc_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((int)e.KeyChar == (int)Keys.Enter)
            {
                ...
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionDescripcionTI(textbox_ActivoDesc.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
                ...
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionMarcaTI(textbox_ActivoDesc.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
                ...
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionModeloTI(textbox_ActivoDesc.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
                ...
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionSerieTI(textbox_ActivoDesc.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
                ...
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionIMEITI(textbox_ActivoDesc.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
                ...
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionMacEtherTI(textbox_ActivoDesc.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
                ...
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_logistica.ListaAsignacionMacWifiTI(textbox_ActivoDesc.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
