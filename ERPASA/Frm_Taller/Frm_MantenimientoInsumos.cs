...
{
    public partial class Frm_MantenimientoInsumos : Form
    {
        ...
        public Frm_MantenimientoInsumos()
        {
            InitializeComponent();
        }

        private void Frm_MantenimientoInsumos_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            frm_AgregarInsumo frbm = new frm_AgregarInsumo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        }
