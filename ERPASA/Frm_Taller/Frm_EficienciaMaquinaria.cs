...
{
    public partial class Frm_EficienciaMaquinaria : Form
    {
        ...
        public Frm_EficienciaMaquinaria()
        {
            InitializeComponent();
        }

        private void Frm_EficienciaMaquinaria_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteEficienciaMaquinaria()
        {
            ...
            dataGridView2.DataSource = cn_taller.ListaReporteEficienciaMaquinaria(
                dateTimePicker_FechaIni.Value.Date, dateTimePicker_FechaFin.Value.Date
                , emp, sed);
        ...
        private void toolStripButton_buscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                BuscarReporteEficienciaMaquinaria();
            }
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            frm_AgregarEficienciaMaquinaria frbm = new frm_AgregarEficienciaMaquinaria();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        }
        ...
        public void BuscarRegistroParaEditar()
        {
            if (dataGridView2.CurrentRow.Cells["Estado"].Value.ToString() == "ACTIVO")
            {
                ...
                frm_EditarEficienciaMaquinaria obj = new frm_EditarEficienciaMaquinaria();
                obj.PonerOscuroComboBox();
                obj.CargarDatosComboBox();
                obj.label_Id.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
                ce_taller.Fecha = Convert.ToDateTime(dataGridView2.CurrentRow.Cells[1].Value);

                ce_taller.empresa = dataGridView2.CurrentRow.Cells[2].Value.ToString();
                ce_taller.sede = dataGridView2.CurrentRow.Cells[3].Value.ToString();

                ce_taller.idVeh = dataGridView2.CurrentRow.Cells[4].Value.ToString();
                ce_taller.DescripcionVehiculo = dataGridView2.CurrentRow.Cells[5].Value.ToString();

                //Eficiencia maquinaria
                ce_taller.turno = dataGridView2.CurrentRow.Cells[10].Value.ToString();
                ce_taller.operador = dataGridView2.CurrentRow.Cells[11].Value.ToString();
                ce_taller.cabezal = dataGridView2.CurrentRow.Cells[12].Value.ToString();
                ce_taller.labor = dataGridView2.CurrentRow.Cells[13].Value.ToString();

                ce_taller.implemento = dataGridView2.CurrentRow.Cells[14].Value.ToString();
                ce_taller.tipolabor = dataGridView2.CurrentRow.Cells[15].Value.ToString();

                ce_taller.objtancada = dataGridView2.CurrentRow.Cells[16].Value.ToString();
                ce_taller.hectarea = dataGridView2.CurrentRow.Cells[17].Value.ToString();
                ce_taller.galones = dataGridView2.CurrentRow.Cells[18].Value.ToString();
                ce_taller.kmIni = dataGridView2.CurrentRow.Cells[19].Value.ToString();
                ce_taller.kmFin = dataGridView2.CurrentRow.Cells[20].Value.ToString();
                ce_taller.kmini_efe = dataGridView2.CurrentRow.Cells[21].Value.ToString();
                ce_taller.kmfin_efe = dataGridView2.CurrentRow.Cells[22].Value.ToString();
                ce_taller.horaini = dataGridView2.CurrentRow.Cells[23].Value.ToString();
                ce_taller.horafin = dataGridView2.CurrentRow.Cells[24].Value.ToString();
                ce_taller.obj_aplicacion = dataGridView2.CurrentRow.Cells[25].Value.ToString();
                ce_taller.observacion = dataGridView2.CurrentRow.Cells[26].Value.ToString();
                ce_taller.indicador = dataGridView2.CurrentRow.Cells[27].Value.ToString();
                ce_taller.descripcion = dataGridView2.CurrentRow.Cells[28].Value.ToString();
        ...
        public void ElimarFila()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                objcntaller.EliminarListaEficiencia(
        ...
        private void textBox_BuscarPor_TextChanged(object sender, EventArgs e)
        {
            foreach (DataGridViewRow Row in dataGridView2.Rows)
            {
                ...
                foreach (DataGridViewCell cell in Row.Cells)
                {
                    ...
                    if (Valor.Contains(this.textBox_BuscarPor.Text))
                    {
                        dataGridView2.Rows[Convert.ToInt32(strFila)].DefaultCellStyle.BackColor = Color.Orange;
                    }
