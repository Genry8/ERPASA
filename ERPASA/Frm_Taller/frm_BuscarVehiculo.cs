...
namespace ERPASA.Frm_Taller
{
    ...
    public partial class frm_BuscarVehiculo : Form
    {
        ...
        public frm_BuscarVehiculo()
        {
            InitializeComponent();
            //FormBorderStyle = FormBorderStyle.None;            
        }

        private void frm_BuscarVehiculo_Load(object sender, EventArgs e)
        {
            comboBox_Tipos.SelectedIndex = 0;
            comboBox_Tipos.DropDownStyle = ComboBoxStyle.DropDownList;
            textbox_DescVehiculo.Focus();

            textbox_DescVehiculo.CharacterCasing = CharacterCasing.Upper;
        ...
        {
            /////////
            VarDatosEntroFormVehiculo var1 = Owner as VarDatosEntroFormVehiculo;
        ...
        private void textbox_ActivoDesc_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                if (comboBox_Tipos.Text == "VEHICULO")
                {
                    dataGridView2.Columns.Clear();
                    dataGridView2.DataSource = cn_taller.ListaVehiculo("%", textbox_DescVehiculo.Text);
                    dataGridView2.AllowUserToAddRows = false;
                    //OrigenColorfila();
                    dataGridView2.ClearSelection();
                }
