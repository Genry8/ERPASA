...
{
    public partial class Frm_ReporteOrdenTrabajo : Form
    {
        ...
        public Frm_ReporteOrdenTrabajo()
        {
            InitializeComponent();
        }

        private void Frm_ReporteOrdenTrabajo_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            comboBox_EstadoOT.SelectedIndex = 0;
            PonerOscuroComboBox();
            CargarDatosComboBox();
            //textBox_Dni.Focus();
        }
        ...
        public void PonerOscuroComboBox()
        {
            ...
            comboBox_EstadoOT.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        public void BuscarReporteOrdenTrabajo()
        {
            ...
            if (comboBox_EstadoOT.Text == "SELECCIONE")
            {
                estado = "%";
            }
            else
            {
                estado = comboBox_EstadoOT.Text;
            }
            ...
            dataGridView2.DataSource = cn_taller.ListaReporteOrdenTrabajo(
        ...
        private void toolStripButton_eliminar_Click(object sender, EventArgs e)
        {
            if (dataGridView2.SelectedRows.Count > 0)
            {
                ...
                {
                    MessageBox.Show("ERROR -- SELECCIONE UN REGISTRO PENDIENTE");
                }
            }
            else
            {
        ...
        public void ElimarFila()
        {
            ...
            {
                objcntaller.EliminarListaOrdenTrabajo(
        ...
        public void OrigenColorfila()
        {
            ...
            for (int i = 0; i < c; i++)
            {
                if (dataGridView2.Rows[i].Cells["Estado"].Value.ToString() == "ELIMINADO")
                {
