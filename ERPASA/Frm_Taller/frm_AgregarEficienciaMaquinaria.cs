...
{
    public partial class frm_AgregarEficienciaMaquinaria : Form, VarDatosEntroFormVehiculo
    {
        private DataSet dtsTablas = new DataSet();
        cn_taller objcntaller = new cn_taller();
        cn_planilla objcnlog = new cn_planilla();

        public frm_AgregarEficienciaMaquinaria()
        {
            InitializeComponent();
        }

        private void frm_AgregarEficienciaMaquinaria_Load(object sender, EventArgs e)
        {
            PonerOscuroComboBox();
            CargarDatosComboBox();
            //AgregarColumna();
        ...
        public void AlertaGuardarCorrectivo()
        {
            ...
            else
            {
                ...
                {
                    objcntaller.GuardarEficienciaMaquinaria(
        ...
        {
            textBox_HoraInicio.Text = "0";
            textBox_HoraFin.Text = "0";
            textBox_Id.Text = "";
            textBox_Vehiculo.Text = "";
            textBox_Operador.Text = "";
            textBox_Cabezal.Text = "";
            textBox_Obj_Tancada.Text = "";
            textBox_Hectarea.Text = "";
            textBox_Galones.Text = "";
            textBox_KilometrajeIni.Text = "";
            textBox_KilometrajeFin.Text = "";
            textBox_KmIniEfec.Text = "";
            textBox_KmFinEfec.Text = "";
            textBox_ObjetivoAplicacion.Text = "";
            textBox_Indicador.Text = "";
            textBox_Descripcion.Text = "";
            textBox_Observacion.Text = "";
        }
    ...
    internal interface VarDatosEntroFormVehiculoEfi
    {
