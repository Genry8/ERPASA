...
{
    public partial class Frm_RegistrarGrupoVehiculo : Form
    {
        ...
        public Frm_RegistrarGrupoVehiculo()
        {
            InitializeComponent();
        }

        private void Frm_RegistrarGrupoVehiculo_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteListaVehiculos()
        {
            ...
            dataGridView2.DataSource = cn_taller.ListaGrupoVehiculo();
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            frm_AgregarGrupoVehiculo frbm = new frm_AgregarGrupoVehiculo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        }
        ...
        public void BuscarRegistroParaEditar()
        {
            ...
            else if (dataGridView2.CurrentRow.Cells["Estado"].Value.ToString() == "ACTIVO")
            {
                ...
                frm_EditarGrupoVehiculo obj = new frm_EditarGrupoVehiculo();
                obj.PonerOscuroComboBox();
                obj.CargarDatosComboBox();
                obj.label_Id.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();

                obj.textBox_Grupo.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
                obj.textBox_Obs.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
        ...
        public void ElimarFila()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                objcntaller.EliminarGrupoVehiculo(
