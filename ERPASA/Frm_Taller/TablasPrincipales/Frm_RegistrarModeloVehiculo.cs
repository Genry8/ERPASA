...
{
    public partial class Frm_RegistrarModeloVehiculo : Form
    {
        ...
        public Frm_RegistrarModeloVehiculo()
        {
            InitializeComponent();
        }

        private void Frm_RegistrarModeloVehiculo_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteListaVehiculos()
        {
            ...
            dataGridView2.DataSource = cn_taller.ListaModeloVehiculo("2", "%");
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            frm_AgregarModeloVehiculo frbm = new frm_AgregarModeloVehiculo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        }
        ...
        public void BuscarRegistroParaEditar()
        {
            ...
            else if (dataGridView2.CurrentRow.Cells["Estado"].Value.ToString() == "ACTIVO")
            {
                ...
                frm_EditarModeloVehiculo obj = new frm_EditarModeloVehiculo();
                obj.PonerOscuroComboBox();
                obj.CargarDatosComboBox();
                obj.label_Id.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
                obj.comboBox_MarcaVehiculo.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
                obj.textBox_Modelo.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
        ...
        public void ElimarFila()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                objcntaller.EliminarModeloVehiculo(
