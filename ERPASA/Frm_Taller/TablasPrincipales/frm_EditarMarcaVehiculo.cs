...
{
    public partial class frm_EditarMarcaVehiculo : Form
    {
        private DataSet dtsTablas = new DataSet();
        cn_taller objcntaller = new cn_taller();
        cn_planilla objcnlog = new cn_planilla();

        public frm_EditarMarcaVehiculo()
        {
            InitializeComponent();
        }

        private void frm_EditarMarcaVehiculo_Load(object sender, EventArgs e)
        {
            //AgregarColumna();
        }
        ...
        public void AlertaActualizarGrupoVehiculo()
        {
            ...
            else
            {
                ...
                string MessageBoxContent = "¿Desea actualizar marca? ";

                DialogResult dialogResult = MessageBox.Show(MessageBoxContent, MessageBoxTitle, MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                if (dialogResult == DialogResult.Yes)
                {

                    objcntaller.ActualizarMarcaVehiculo(
                    label_Id.Text,
