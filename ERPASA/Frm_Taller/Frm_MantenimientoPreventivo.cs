...
{
    public partial class Frm_MantenimientoPreventivo : Form
    {
        ...
        public Frm_MantenimientoPreventivo()
        {
            InitializeComponent();
        }

        private void Frm_MantenimientoPreventivo_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteMantenimientoPreventivo()
        {
            ...
            dataGridView2.DataSource = cn_taller.ListaReporteMantenimientoPrev(
