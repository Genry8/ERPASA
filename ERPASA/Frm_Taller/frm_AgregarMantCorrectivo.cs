...
{
    public partial class frm_AgregarMantCorrectivo : Form, VarDatosEntroFormVehiculo
    {
        private DataSet dtsTablas = new DataSet();
        cn_taller objcntaller = new cn_taller();
        cn_planilla objcnlog = new cn_planilla();

        public frm_AgregarMantCorrectivo()
        {
            InitializeComponent();
        }

        private void frm_AgregarMantCorrectivo_Load(object sender, EventArgs e)
        {
            PonerOscuroComboBox();
            CargarDatosComboBox();
            //AgregarColumna();
        ...
        public void AlertaGuardarCorrectivo()
        {
            ...
            else
            {
                ...
                {
                    objcntaller.GuardarMantenimientoCorrectivo(
                    ...
                    comboBox_Sistema.Text.Trim(),//status
                    comboBox_Sustento.Text.Trim(),//status
                    comboBox_TipoCorrectivo.Text.Trim(),//status
                    comboBox_TipoFalla.Text.Trim(),//status
    ...
    internal interface VarDatosEntroFormVehiculoCo
    {
