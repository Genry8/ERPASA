...
{
    public partial class Frm_MantenimientoCorrectivo : Form
    {
        ...
        public Frm_MantenimientoCorrectivo()
        {
            InitializeComponent();
        }

        private void Frm_MantenimientoCorrectivo_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteMantenimientoCorrectivo()
        {
            ...
            dataGridView2.DataSource = cn_taller.ListaReporteMantenimientoCorrectivo(
        ...
        private void toolStripButton_buscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                BuscarReporteMantenimientoCorrectivo();
            }
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            frm_AgregarMantCorrectivo frbm = new frm_AgregarMantCorrectivo();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        }
        ...
        public void BuscarRegistroParaEditar()
        {
            if (dataGridView2.CurrentRow.Cells["Estado"].Value.ToString() == "ACTIVO")
            {
                ...
                frm_EditarMantCorrectivo obj = new frm_EditarMantCorrectivo();
                ...
                ce_taller.FecIng = Convert.ToDateTime(dataGridView2.CurrentRow.Cells[9].Value);
                ce_taller.FecSal = Convert.ToDateTime(dataGridView2.CurrentRow.Cells[10].Value);
                ce_taller.diasInop = dataGridView2.CurrentRow.Cells[11].Value.ToString();
                ce_taller.hrsInop = dataGridView2.CurrentRow.Cells[12].Value.ToString();
                ce_taller.km = dataGridView2.CurrentRow.Cells[13].Value.ToString();

                ce_taller.status = dataGridView2.CurrentRow.Cells[14].Value.ToString();
                ce_taller.detalleObs = dataGridView2.CurrentRow.Cells[15].Value.ToString();

                ce_taller.sistema = dataGridView2.CurrentRow.Cells[16].Value.ToString();
                ce_taller.sustento = dataGridView2.CurrentRow.Cells[17].Value.ToString();
                ce_taller.tipocorrectivo = dataGridView2.CurrentRow.Cells[20].Value.ToString();
                ce_taller.tipofalla = dataGridView2.CurrentRow.Cells[21].Value.ToString();
                ce_taller.costo = dataGridView2.CurrentRow.Cells[22].Value.ToString();
        ...
        public void ElimarFila()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                objcntaller.EliminarListaMantCorrectivo(
