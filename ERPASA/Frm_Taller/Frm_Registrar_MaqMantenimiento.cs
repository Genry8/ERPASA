...
{
    public partial class Frm_Registrar_MaqMantenimiento : Form
    {
        ...
        public Frm_Registrar_MaqMantenimiento()
        {
            InitializeComponent();
        }

        private void Frm_Registrar_MaqMantenimiento_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
        ...
        public void GuardarMantMaquinaria()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    var extall = cn_taller.BuscExisteEficienciaMaquinaria(
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,
                    dataGridView1[1, i].Value.ToString().Trim(),
                    dataGridView1[6, i].Value.ToString().Trim(),
                    dataGridView1[7, i].Value.ToString().Trim(),
                    dataGridView1[8, i].Value.ToString().Trim()
                    );
