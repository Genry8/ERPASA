...
{
    public partial class Frm_ReporteAbastecimiento_Corte : Form
    {
        ...
        public Frm_ReporteAbastecimiento_Corte()
        {
            InitializeComponent();
        ...
        private void Frm_ReporteAbastecimiento_Corte_Load(object sender, EventArgs e)
        {
        ...
        public void BuscarUsuarioAbastecimiento()
        {
            ...
            dataGridView1.DataSource = cn_almacen.BuscarPedateoAbastecimientoGrifoCorte(
