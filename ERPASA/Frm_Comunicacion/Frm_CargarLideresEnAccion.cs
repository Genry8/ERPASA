...
{
    public partial class Frm_CargarLideresEnAccion : Form
    {
        ...
        public Frm_CargarLideresEnAccion()
        {
            InitializeComponent();
        }

        private void Frm_CargarLideresEnAccion_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarLideresEnAccion()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_comunicacion.BuscExisteLideresEnAccion(
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//empresa
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//sede
                        Convert.ToDateTime(dataGridView1[1, i].Value).Date, //Fecha
                        Convert.ToInt32(dataGridView1[0, i].Value) //item
                        );

                    if (dataGridView1[8, i].Value.ToString() == "")
                    {
                        dataGridView1[8, i].Value = "0";
                    }
                    if (dataGridView1[10, i].Value.ToString() == "")
                    {
                        dataGridView1[10, i].Value = "0";
                    }

                    if (exrev == true)
                    {
                        objcnlog.ActualizarLideresEnAccion(
                        Convert.ToInt32(dataGridView1[0, i].Value),//item
                        ...
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//empresa
                        dataGridView1[5, i].Value.ToString().Trim(),//sede
                        //comboBox_Sede.Text,//Sede
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//area
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//jefe

                        Convert.ToDecimal(dataGridView1[8, i].Value),//puntaje
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//categoria
                        Convert.ToInt32(dataGridView1[10, i].Value),//estrellas
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//premio
                    ...
                    {
                        objcnlog.GuardarLideresEnAccion(
                        Convert.ToInt32(dataGridView1[0, i].Value),//item
                        Convert.ToDateTime(dataGridView1[1, i].Value),//fecha
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//apenom
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//dni
