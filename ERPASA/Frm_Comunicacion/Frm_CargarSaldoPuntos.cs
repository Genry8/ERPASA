...
{
    public partial class Frm_CargarSaldoPuntos : Form
    {
        ...
        public Frm_CargarSaldoPuntos()
        {
            InitializeComponent();
        }

        private void Frm_CargarSaldoPuntos_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarSaldos()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    objcnlog.GuardarActualizarSaldo(
                        dateTimePicker_FecSaldoPuntos.Value.Date,
                        dataGridView1[0, i].Value.ToString().Trim(),//empresa
                        dataGridView1[1, i].Value.ToString().Trim(),//nombre
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//dni
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//correo
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//telefono
                        Convert.ToDecimal(dataGridView1[5, i].Value.ToString().Trim()),//saldo
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//activo
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//est_planilla
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//acceso
                        Convert.ToInt32(comboBox_Semana.Text.Trim()),//semana
                        Convert.ToInt32(comboBox_Año.Text.Trim()),//año
                        "",//OBS
