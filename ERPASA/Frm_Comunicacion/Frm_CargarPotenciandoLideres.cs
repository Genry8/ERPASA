...
{
    public partial class Frm_CargarPotenciandoLideres : Form
    {
        ...
        public Frm_CargarPotenciandoLideres()
        {
            InitializeComponent();
        }

        private void Frm_CargarPotenciandoLideres_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarPotenciandoLideres()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    var exrev = cn_comunicacion.BuscExistePotenciandoLideres(
                        comboBox_empresa.Text,//empresa
                        comboBox_Sede.Text,//sede
                        Convert.ToDateTime(dataGridView1[5, i].Value).Date, //Fecha
                    ...
                    if (exrev == true)
                    {
                        objcnlog.ActualizarPotenciandoLideres(
                        Convert.ToInt32(dataGridView1[0, i].Value),//item
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//cabezal
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//Area
                        comboBox_empresa.Text,//Empresa
                        comboBox_Sede.Text,//Sede
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//supervisor
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//dni sup
                        Convert.ToDateTime(dataGridView1[5, i].Value),//fecha
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//entrev
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//dimensiones
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//obs
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//obs gen
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//apoyo
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//cuando
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//cuanfin

                        dataGridView1[13, i].Value.ToString().ToUpper().Trim(),//reaini
                        dataGridView1[14, i].Value.ToString().ToUpper().Trim(),//reafin
                        dataGridView1[15, i].Value.ToString().ToUpper().Trim(),//est_avance
                    ...
                    {
                        objcnlog.GuardarPotenciandoLideres(
                        Convert.ToInt32(dataGridView1[0, i].Value),//item
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//cabezal
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//Area
                        comboBox_empresa.Text,//Empresa
