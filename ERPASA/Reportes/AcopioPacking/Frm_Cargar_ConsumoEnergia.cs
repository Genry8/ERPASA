...
{
    public partial class Frm_Cargar_ConsumoEnergia : Form
    {
        ...
        public Frm_Cargar_ConsumoEnergia()
        {
            InitializeComponent();
        }

        private void Frm_Cargar_ConsumoEnergia_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarCumplimientoCertificacion()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //objcnlog.BuscConsumoEnergia(
                //        comboBox_empresa.Text.Trim(),
                //        comboBox_sede.Text.Trim(),
                //        dataGridView1[0, i].Value.ToString().Trim(),//grupo
                //        dataGridView1[1, i].Value.ToString().Trim()//fecha
                ...
                {
                    objcnlog.GuardarConsumoEnergia(
                        comboBox_empresa.Text.Trim(),
                        comboBox_sede.Text.Trim(),
                        dataGridView1[0, i].Value.ToString().ToUpper().Trim(),//grupo
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//fecha
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//horas
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//consumo
