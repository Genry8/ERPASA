...
namespace ERPASA.Reportes.Administracion
{
    public partial class Frm_Reporte_CosechaValvula : Form
    {
        ...
        public Frm_Reporte_CosechaValvula()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_CosechaValvula_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void PonerOscuroComboBox()
        {
            ...
            comboBox_detalle_cabezal.DropDownStyle = ComboBoxStyle.DropDownList;
        }
        ...
        public void CargarDatosComboBox()
        {
            ...
            comboBox_detalle_cabezal.DataSource = cn_logistica.ListaCBCabezal();
            comboBox_detalle_cabezal.DisplayMember = "Cabezal"; //NOMBRE DE LA TABLA O NOMBRE DE COLUMNA ID
            comboBox_detalle_cabezal.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA ORDENAR
        }
        ...
        public void BuscarReporteCosechaVal()
        {
            ...
            if (comboBox_detalle_cabezal.Text == "SELECCIONE")
            {
                cab = "%";
            }
            else
            {
                cab = comboBox_detalle_cabezal.Text;
            }
            ...
            dataGridView2.DataSource = cn_administracion.ListaReporteCosechaValvula(
                dateTimePicker_FecInicio.Value.Date
            ...
            dataGridView1.DataSource = cn_administracion.ListaReporteCosechaValvulaVariedad(
                dateTimePicker_FecInicio.Value.Date
                , dateTimePicker_FecFin.Value.Date, emp
                , sed, cab);
