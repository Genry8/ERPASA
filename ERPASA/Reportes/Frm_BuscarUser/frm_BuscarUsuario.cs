...
namespace ERPASA.Reportes
{
    ...
    public partial class frm_BuscarUsuario : Form
    {
        ...
        private void frm_BuscarUsuario_Load(object sender, EventArgs e)
        {
            textbox_usuariodes.CharacterCasing = CharacterCasing.Upper;
            dataGridView2.Columns.Clear();
            dataGridView2.DataSource = cn_reportes.BuscListUserVent(textbox_usuariodes.Text);
            dataGridView2.AllowUserToAddRows = false;
            dataGridView2.ClearSelection();
            textbox_usuariodes.Focus();
            //OrigenColorfila();
        ...
        public void OrigenColorfila()
        {
            ...
            for (int i = 0; i < c; i++)
            {
                if (dataGridView2.Rows[i].Cells[9].Value.ToString() == "INACTIVO")
                {
                    dataGridView2.Rows[i].DefaultCellStyle.ForeColor = Color.Red; //DarkRed
