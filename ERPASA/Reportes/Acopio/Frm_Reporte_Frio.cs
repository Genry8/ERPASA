...
{
    public partial class Frm_Reporte_Frio : Form
    {
        ...
        public Frm_Reporte_Frio()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_Frio_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteFrio()
        {
            ...
            dataGridView2.DataSource = cn_sst.ListaReporteFrio(dateTimePicker_FecInicio.Value.Date
