...
{
    public partial class Frm_Reporte_PT : Form
    {
        ...
        public Frm_Reporte_PT()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_PT_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReportePT()
        {
            ...
            {
                palet = textBox_numPallet.Text.Trim();
            }
            ...
            dataGridView2.DataSource = cn_sst.ListaReportePT(dateTimePicker_FecInicio.Value.Date
            ...
            dataGridView1.DataSource = cn_sst.ListaReportePTMaquina(dateTimePicker_FecInicio.Value.Date
                , dateTimePicker_FecFin.Value.Date, emp
                , sed, cult);
            ...
            dataGridView3.DataSource = cn_sst.ListaReportePTPresentacion(dateTimePicker_FecInicio.Value.Date
                , dateTimePicker_FecFin.Value.Date, emp
                , sed, cult);
