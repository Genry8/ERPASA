...
{
    public partial class Frm_Reporte_Gasificado : Form
    {
        ...
        public Frm_Reporte_Gasificado()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_Gasificado_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteGasificado()
        {
            ...
            dataGridView2.DataSource = cn_sst.ListaReporteGasificado(dateTimePicker_FecInicio.Value.Date
