...
{
    public partial class Frm_SavePresentacion : Form
    {
        ...
        public Frm_SavePresentacion()
        {
            InitializeComponent();
        }

        private void Frm_SavePresentacion_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReportePresentacion()
        {
            ...
            dataGridView2.DataSource = cn_sst.ListaReportePresentacion(emp
                , sed);
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            frm_AgregarPresentacion frbm = new frm_AgregarPresentacion();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        }
        ...
        public void BuscarRegistroParaEditar()
        {
            if (dataGridView2.CurrentRow.Cells["Estado"].Value.ToString() == "ACTIVO")
            {
                ...
                frm_EditarPresentacion obj = new frm_EditarPresentacion();
                obj.PonerOscuroComboBox();
                obj.CargarDatosComboBox();
                obj.label_Id.Text = dataGridView2.CurrentRow.Cells[0].Value.ToString();
                obj.label_Cultivo.Text = dataGridView2.CurrentRow.Cells[2].Value.ToString();
                obj.label_codPre.Text = dataGridView2.CurrentRow.Cells[1].Value.ToString();
                obj.label_presentacion.Text = dataGridView2.CurrentRow.Cells[3].Value.ToString();
                ...
                obj.textBox_Peso.Text = dataGridView2.CurrentRow.Cells[4].Value.ToString();
                obj.textBox_cajas.Text = dataGridView2.CurrentRow.Cells[5].Value.ToString();
        ...
        public void ElimarFila()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                objcnpack.EliminarPresentacion(
