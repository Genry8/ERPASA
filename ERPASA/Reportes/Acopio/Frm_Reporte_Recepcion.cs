...
{
    public partial class Frm_Reporte_Recepcion : Form
    {
        ...
        public Frm_Reporte_Recepcion()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_Recepcion_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarRecepcionAcopio()
        {
            ...
            dataGridView2.DataSource = cn_sst.ListaRecepcion(dateTimePicker_FecInicio.Value.Date
            ...
            dataGridView1.DataSource = cn_sst.ListaRecepcionVariedad(dateTimePicker_FecInicio.Value.Date
                , dateTimePicker_FecFin.Value.Date, emp
                , sed);
