...
{
    public partial class Frm_Reporte_TomaMuestra : Form
    {
        ...
        public Frm_Reporte_TomaMuestra()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_TomaMuestra_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void CargarDatosComboBox()
        {
            ...
            comboBox_Variedad.ValueMember = "DesVar"; // NOMBRE DE LA COLUMNA o PARA ORDENAR
        ...
        public void BuscarReporteTomaMuestra()
        {
            ...
            dataGridView2.DataSource = cn_sst.ListaReporteTomaMuestra(dateTimePicker_FecInicio.Value.Date
            ...
            //dataGridView1.DataSource = cn_sst.ListaReporteVolcadoMaquina(dateTimePicker_FecInicio.Value.Date
            //    , dateTimePicker_FecFin.Value.Date, emp
            //    , sed, cult, var);
            ...
            //dataGridView3.DataSource = cn_sst.ListaReporteVolcadoVariedad(dateTimePicker_FecInicio.Value.Date
            //    , dateTimePicker_FecFin.Value.Date, emp
            //    , sed, cult, var);
