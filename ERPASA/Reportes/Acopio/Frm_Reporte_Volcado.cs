...
{
    public partial class Frm_Reporte_Volcado : Form
    {
        ...
        public Frm_Reporte_Volcado()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_Volcado_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteVolcado()
        {
            ...
            dataGridView2.DataSource = cn_sst.ListaReporteVolcado(dateTimePicker_FecInicio.Value.Date
