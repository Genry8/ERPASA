...
{
    public partial class Frm_Reporte_RecepcionAcopio : Form
    {
        ...
        public Frm_Reporte_RecepcionAcopio()
        {
            InitializeComponent();
        }

        private void Frm_Reporte_AtenMed_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarRecepcionAcopio()
        {
            ...
            dataGridView2.DataSource = cn_sst.ListaRecepcionAcopio(dateTimePicker_FecInicio.Value.Date
            ...
            dataGridView1.DataSource = cn_sst.ListaRecepcionAcopioVariedad(dateTimePicker_FecInicio.Value.Date
                , dateTimePicker_FecFin.Value.Date, emp
                , sed);
            ...
            dataGridView3.DataSource = cn_sst.ListaRecepcionAcopioProducto(dateTimePicker_FecInicio.Value.Date
                , dateTimePicker_FecFin.Value.Date, emp
                , sed);
