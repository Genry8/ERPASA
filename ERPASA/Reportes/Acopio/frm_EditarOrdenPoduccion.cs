...
{
    public partial class frm_EditarOrdenPoduccion : Form
    {
        cn_packing objcnpack = new cn_packing();
        cn_planilla objcnlog = new cn_planilla();

        public frm_EditarOrdenPoduccion()
        {
            InitializeComponent();
        }
        ...
        public void AlertaGuardarMermas()
        {
            ...
            else if (textBox_Prioridad.Text.Trim() == "")
            {
                Msbox.Frm_NotificacionesPeligro ng =
            ...
            else
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    objcnpack.ActualizarOrdenPRD(
                    Convert.ToInt32(label_Id.Text.ToString()),
                    textBox_NumCont.Text, //num cont
                    textBox_Prioridad.Text,//prioridad
                    textBox_Orden.Text,//orden
                    textBox_Cliente.Text,//cliente
                    textBox_Destino.Text,//destino
                    textBox_Presentacion.Text,//presentacion
                    textBox_Calibre.Text,//calibre
                    textBox_Cajas.Text,//cajas
                    textBox_Pallets.Text,// pallets
