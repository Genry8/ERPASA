...
{
    public partial class Frm_AcopioRecepcion : Form
    {
        ...
        cn_nisira objcndatnisira = new cn_nisira();

        public Frm_AcopioRecepcion()
        {
            InitializeComponent();
        }

        private void Frm_AcopioRecepcion_Load(object sender, EventArgs e)
        {
        ...
        public void ImprimirAcopioRecepcion()
        {
            ...
            Acopio.CrystalReportAcopio objCryRep = new Acopio.CrystalReportAcopio();
            //string dir = @"~\CryRep_VentasUsuario.rpt";
            objCryRep.Load(@"~\CrystalReportAcopio.rpt");
        ...
        {
            pallet = dataGridView1.CurrentRow.Cells[2].Value.ToString();
            cabezal = dataGridView1.CurrentRow.Cells[3].Value.ToString();
            variedad = dataGridView1.CurrentRow.Cells[4].Value.ToString();
            kilos = dataGridView1.CurrentRow.Cells[5].Value.ToString();
            MessageBox.Show("ELEGIDO" + pallet);
