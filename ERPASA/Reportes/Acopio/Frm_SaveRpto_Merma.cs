...
{
    public partial class Frm_SaveRpto_Merma : Form
    {
        ...
        public Frm_SaveRpto_Merma()
        {
            InitializeComponent();
        }

        private void Frm_SaveRpto_Merma_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //MAYUSCULA
            PonerOscuroComboBox();
        ...
        public void BuscarReporteMerma()
        {
            ...
            if (comboBox_TipoMerma.Text == "SELECCIONE")
            {
                merma = "%";
            }
            else
            {
                merma = comboBox_TipoMerma.Text;
            }
            ...
            dataGridView2.DataSource = cn_sst.ListaReporteMerma(dateTimePicker_FecInicio.Value.Date
        ...
        private void toolStripButton_nuevo_Click(object sender, EventArgs e)
        {
            ...
            frm_AgregarMerma frbm = new frm_AgregarMerma();
            AddOwnedForm(frbm);
            frbm.ShowDialog();
        }
        ...
        {
            if (dataGridView2.CurrentRow.Cells[10].Value.ToString() == "ACTIVO")
            {

                frm_EditarMerma obj = new frm_EditarMerma();
                ...
                obj.comboBox_TipoMerma.Text = dataGridView2.CurrentRow.Cells[6].Value.ToString();
                obj.comboBox_Variedad.Text = dataGridView2.CurrentRow.Cells[7].Value.ToString();
                obj.comboBox_Maquina.Text = dataGridView2.CurrentRow.Cells[8].Value.ToString();
                obj.textBox_Kilos.Text = dataGridView2.CurrentRow.Cells[9].Value.ToString();
