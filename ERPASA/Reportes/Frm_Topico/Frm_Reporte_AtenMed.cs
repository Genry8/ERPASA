...
{
    public partial class Frm_Reporte_AtenMed : Form
    {
        ...
        public void BuscarPacienteAtendido()
        {
            ...
            dataGridView2.DataSource = cn_sst.ListaAtencionPaciente(dateTimePicker_FecInicio.Value.Date
                , dateTimePicker_FecFin.Value.Date, emp
                , sed, textBox_Dni.Text);
