...
{
    public partial class Frm_Cargar_CumplimientoDocumentos : Form
    {
        private DataSet dtsTablas = new DataSet();
        private DataSet dtsTablasLicencia = new DataSet();
        cn_sig objcnlog = new cn_sig();


        public Frm_Cargar_CumplimientoDocumentos()
        {
            InitializeComponent();
        }

        private void Frm_Cargar_CumplimientoDocumentos_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarCumplimientoDocumento()
        {
            ...
            {
                objcnlog.EliminarCumplimientoDocumentos(
                ...
                {
                    objcnlog.GuardarCumplimientoDocumentos(
                        Convert.ToInt32(comboBox_Año.Text),
                        Convert.ToInt32(comboBox_Semana.Text),
                        ...
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//revision
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//titulo
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//solicitante
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//Fecha Solicitud

                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//tipo documento
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//gerencia
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//area
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//tipo actividad
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//responsable
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//etapa flujo
                        dataGridView1[13, i].Value.ToString().ToUpper().Trim(),//fecha registro
                        dataGridView1[14, i].Value.ToString().ToUpper().Trim(),//condicion

                        dataGridView1[15, i].Value.ToString().ToUpper().Trim(),//detalle obs
                        dataGridView1[16, i].Value.ToString().ToUpper().Trim(),//fecha publicacion
                        comboBox_Hojas.Text,
                        "S",
