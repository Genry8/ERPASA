...
{
    public partial class Frm_Cargar_CumplimientoCertificaciones : Form
    {
        ...
        public Frm_Cargar_CumplimientoCertificaciones()
        {
            InitializeComponent();
        }

        private void Frm_Cargar_CumplimientoCertificaciones_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
            ...
            comboBox_norma.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        private void toolStripButton_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count >= 1)
            {
                ...
                try
                {
                    ...
                    {
                        GuardarCumplimientoCertificacion();
                    }
        ...
        public void GuardarCumplimientoCertificacion()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                objcnlog.EliminarCumplimientoCertificacion(
                ...
                {
                    objcnlog.GuardarCumplimientoCertificaciones(
                        Convert.ToInt32(comboBox_Año.Text),
                        Convert.ToInt32(comboBox_Semana.Text),
                        "0",//id
                        comboBox_empresa.Text.Trim(),
                        comboBox_sede.Text.Trim(),
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//nombre requisito
                        "",//requisito
                        "",//nivel
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//gerencia
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//area
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//responsable

                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//evidencia

                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//frecuencia
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//fecha planificada
                        comboBox_norma.Text,//tipo norma
