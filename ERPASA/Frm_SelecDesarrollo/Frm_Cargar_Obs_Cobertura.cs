...
{
    public partial class Frm_Cargar_Obs_Cobertura : Form
    {
        ...
        public Frm_Cargar_Obs_Cobertura()
        {
            InitializeComponent();
        }

        private void Frm_Cargar_Obs_Cobertura_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarObsCobertura()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    objcnlog.GuardarObsCobertura(
                        comboBox_empresa.Text.Trim(),
                        comboBox_sede.Text.Trim(),
                        dataGridView1[0, i].Value.ToString().ToUpper().Trim(),//area
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//fecha
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//obs
