...
{
    public partial class Frm_CargarGrupoLabor : Form
    {
        ...
        public Frm_CargarGrupoLabor()
        {
            InitializeComponent();
        }

        private void Frm_CargarGrupoLabor_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarGrupoLabor()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    var exrev = cn_planilla.BuscExisteGrupoLabor(
                        dataGridView1[0, i].Value.ToString().Trim(),
                        dataGridView1[1, i].Value.ToString().Trim());

                    if (exrev == true)
                    {
                        objcnlog.ActualizarGrupoLabor(
                        dataGridView1[0, i].Value.ToString().Trim(),//cod
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//grupo
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//empresa
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//etapa
                        "",//OBS
