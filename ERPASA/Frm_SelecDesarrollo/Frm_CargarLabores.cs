...
{
    public partial class Frm_CargarLabores : Form
    {
        ...
        public Frm_CargarLabores()
        {
            InitializeComponent();
        }

        private void Frm_CargarLabores_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarLabores()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    var exrev = cn_planilla.BuscExisteLabor(
                        dataGridView1[0, i].Value.ToString().Trim());

                    if (exrev == true)
                    {
                        objcnlog.ActualizarLabor(
                        ...
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//numpers
                        ...
                        Convert.ToDecimal(dataGridView1[8, i].Value.ToString().Trim()),//meta
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//cultivo
                        Convert.ToDecimal(dataGridView1[10, i].Value.ToString().Trim()),//precio unit
                        "",//OBS
