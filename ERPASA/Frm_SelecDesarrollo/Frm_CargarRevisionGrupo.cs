...
{
    public partial class Frm_CargarRevisionGrupo : Form
    {
        ...
        public Frm_CargarRevisionGrupo()
        {
            InitializeComponent();
        }

        private void Frm_CargarRevisionGrupo_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarRevisionGrupo()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    var exrev = cn_planilla.BuscExisteRevisionGrupo(dataGridView1[2, i].Value.ToString().Trim(), Convert.ToDateTime(dataGridView1[10, i].Value).Date);
                    if (exrev == true)
                    {
                        objcnlog.ActualizarRevisionGrupo(
                        ...
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//grupotrab
                        Convert.ToInt32(dataGridView1[3, i].Value),//numpers
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//agrup la
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//labor
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//fundo
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//cabezal
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//supervisor
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//cultivo
                        Convert.ToDateTime(dataGridView1[10, i].Value).Date,//fecha grupo
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//meta
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//precio unit
                        "",//OBS
