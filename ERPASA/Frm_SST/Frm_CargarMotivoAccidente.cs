...
{
    public partial class Frm_CargarMotivoAccidente : Form
    {
        ...
        public Frm_CargarMotivoAccidente()
        {
            InitializeComponent();
        }

        private void Frm_CargarMotivoAccidente_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
            Cargar_Empresa();
        ...
        public void GuardarMotivoAccidente()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    objcnlog.GuardarMotivoAccidente(
                        dataGridView1[0, i].Value.ToString().ToUpper().Trim(),//dni
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//apenom
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//fecha
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//obs
                        comboBox_Hojas.Text,
                        "",
