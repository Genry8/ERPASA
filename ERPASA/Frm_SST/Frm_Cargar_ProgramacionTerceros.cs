...
{
    public partial class Frm_Cargar_ProgramacionTerceros : Form
    {
        ...
        public Frm_Cargar_ProgramacionTerceros()
        {
            InitializeComponent();
        }

        private void Frm_Cargar_ProgramacionTerceros_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarProgramacionTerceros()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    objcnlog.GuardarProgramacionTerceros(
                        dataGridView1[0, i].Value.ToString().Trim(),//sem
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//ruc
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//proveedor
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//numero OS
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//des trab
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//lugar trab
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//sede

                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//area sol
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//jefatura
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//cant trab
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//fec ini
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//fec fin
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//obs
