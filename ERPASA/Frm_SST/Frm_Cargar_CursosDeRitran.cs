...
{
    public partial class Frm_Cargar_CursosDeRitran : Form
    {
        ...
        public Frm_Cargar_CursosDeRitran()
        {
            InitializeComponent();
        }

        private void Frm_Cargar_CursosDeRitran_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarCursoDeRitran()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    objcnlog.GuardarCursoRitran(
                        ...
                        "", //CARGO
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//FECHA VENC MTC
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//FECHA CAPAcit
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//FECHA VEN RITRAN

                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//NOTA EXAMEN
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//FECHA ENTREGA
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//UNIDAD MANEJAR
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//FECHA MULTA
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//UNIDAD MANEJAR
                        dataGridView1[13, i].Value.ToString().ToUpper().Trim(),//OBS
