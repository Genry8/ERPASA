...
{
    public partial class Frm_Cargar_AtenMed : Form
    {
        ...
        public Frm_Cargar_AtenMed()
        {
            InitializeComponent();
        }

        private void Frm_Cargar_AtenMed_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarAtenMed()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    cn_planilla.BuscExisteAtenMedica(dataGridView1[3, i].Value.ToString().Trim(), Convert.ToDateTime(dataGridView1[0, i].Value).Date);
                    if (dataGridView1[3, i].Value.ToString().Trim() == ce_topico.dni_paciente & Convert.ToDateTime(dataGridView1[0, i].Value).Date == ce_topico.Fecha.Date)
                    {
                        ...
                        true,//QUINCENA
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//MES
                        "",
                        "",
                        ...
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//JEFEAREA
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//PATOLOGIA
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//DIAGNOSTICO
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//SINTOMAS
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//TRATAMIENTO
                        Convert.ToDecimal(dataGridView1[11, i].Value),//CANT MEDICAMENTO
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//ACCION REALIZADA
                        "",
                        "",
                        Convert.ToDateTime(dataGridView1[13, i].Value),//HR_ENT
                        Convert.ToDateTime(dataGridView1[14, i].Value),//HR_SAL
