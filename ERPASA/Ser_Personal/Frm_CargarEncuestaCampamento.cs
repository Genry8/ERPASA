...
{
    public partial class Frm_CargarEncuestaCampamento : Form
    {
        ...
        public Frm_CargarEncuestaCampamento()
        {
            InitializeComponent();
        }

        private void Frm_CargarEncuestaCampamento_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarEncuestaCampamento()
        {
            ...
            {
                objcnlog.EliminarEncuestaCampamento(
                    comboBox_Sede.Text,
                ...
                {
                    objcnlog.GuardarEncuestaCampamento(
                        ...
                        dataGridView1[14, i].Value.ToString().ToUpper().Trim(),//item_9

                        dataGridView1[15, i].Value.ToString().ToUpper().Trim(),//sugerencia_recomend
                        comboBox_TipoPersonal.Text,
                        comboBox_Hojas.Text,
                        "S",
