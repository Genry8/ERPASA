...
{
    public partial class Frm_ReporteCom : Form
    {
        ...
        private void Frm_ReporteCom_Load(object sender, EventArgs e)
        {
        ...
        public void BuscarUsuarioPedateado()
        {
            ...
            dataGridView1.DataSource = cn_logistica.BuscarPedateoPersonalComedorReporte(
