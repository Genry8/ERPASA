...
{
    public partial class Frm_CargarAsistenciaPersonal : Form
    {
        ...
        public Frm_CargarAsistenciaPersonal()
        {
            InitializeComponent();
        }

        private void Frm_CargarAsistenciaPersonal_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarAsistencia()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    objcnlog.GuardarAsistencia(
                        dataGridView1[0, i].Value.ToString().ToUpper().Trim(),//asistencia
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//punto control
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//tipo
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//fecha
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//dni
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//nombres
                        comboBox_Año.Text,
                        comboBox_Semana.Text,
                        comboBox_Hojas.Text,
                        "",
