...
{
    public partial class Frm_CargarListaVehiculos : Form
    {
        ...
        public Frm_CargarListaVehiculos()
        {
            InitializeComponent();
        }

        private void Frm_CargarListaVehiculos_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
            Cargar_Empresa();
        ...
        public void GuardarListaVehiculos()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    objcnlog.GuardarListaVehiculos(

                        dataGridView1[0, i].Value.ToString().Trim(),//id
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//placa
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//tipo veh
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//ruc
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//transportista
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//capacidad
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//venc soat
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//venc revtec

                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//venc permiso
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//activo
