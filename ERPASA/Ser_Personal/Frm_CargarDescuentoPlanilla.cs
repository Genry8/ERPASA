...
{
    public partial class Frm_CargarDescuentoPlanilla : Form
    {
        ...
        public Frm_CargarDescuentoPlanilla()
        {
            InitializeComponent();
        }

        private void Frm_CargarDescuentoPlanilla_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void GuardarDescuentoPlanilla()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    objcnlog.GuardarDescuentoComedorPlanilla(
                        dataGridView1[0, i].Value.ToString().ToUpper().Trim(),//dni
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//nombres
                        "",//empresa
                        "",//sede
                        "",//comedor
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//monto
                        "",
                        "",
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//fecini
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//fecfin
                        comboBox_Hojas.Text,
                        "",
