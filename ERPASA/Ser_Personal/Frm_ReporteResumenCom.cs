...
{
    public partial class Frm_ReporteResumenCom : Form
    {
        ...
        private void Frm_ReporteResumenCom_Load(object sender, EventArgs e)
        {
        ...
        public void BuscarUsuarioPedateadoInasistencia()
        {
            ...
            dataGridView1.DataSource = cn_logistica.BuscarPedateoPersonalComedorResumen(
            ...
            dataGridView2.DataSource = cn_logistica.BuscarPedateoPersonalComedorResumen_Detalle(
            dateTimePicker_Comedor_F_Inicio.Value.Date, dateTimePicker_Fecha_Final.Value.Date
            , tipopersonal, emp, sede);
            dataGridView2.AllowUserToAddRows = false;
            //SumarTotal();
