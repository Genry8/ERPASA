...
{
    public partial class Frm_MarcarCom : Form
    {
        ...
        private void Frm_MarcarCom_Load(object sender, EventArgs e)
        {
        ...
        private void textBox_Dni_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == (int)Keys.Enter)
            {
                ...
                var cnexiste = cn_logistica.BuscExistePersonalComedor(textBox_Dni.Text.Trim(), comboBox_tipo.Text, comboBox_CodSede_Comedor.Text, currentDateTime);
        ...
        public void GuardarUsuarioPedateado()
        {
            ...
            else
            {
                ...
                //if ( comboBox_tipo.Text == ce_comedor.CodPedateoTipoAlimentoExist)
                //{
