...
{
    public partial class Frm_CargarInspecciones : Form
    {
        ...
        public Frm_CargarInspecciones()
        {
            InitializeComponent();
        }

        private void Frm_CargarInspecciones_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    objcnlog.GuardarInspeccion(
                        ...
                        Convert.ToInt32(dataGridView1[14, i].Value),//SEMANA
                        comboBox_empresa.Text,//EMPRESA
                        comboBox_Sede.Text,//SEDE
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//AREA
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//INCIDENCIA
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//HALLAZGO
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//PELIGRO
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//TIPO JERARAQUIA
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//HALLAZGO_DESVIACION
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//MEDIDA CORRECTIVA
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//RESPONSABLE
                        dataGridView1[9, i].Value.ToString().Trim(),//FEC REP
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//ESTADO INSPECCION
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//MEDIDA CORRECTIVA 2
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//EVIDENCIA
                        dataGridView1[13, i].Value.ToString().Trim(),//FEC LEVANT
