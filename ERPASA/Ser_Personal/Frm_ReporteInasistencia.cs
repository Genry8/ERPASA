...
{
    public partial class Frm_ReporteInasistencia : Form
    {
        ...
        public Frm_ReporteInasistencia()
        {
            InitializeComponent();
        ...
        private void Frm_ReporteInasistencia_Load(object sender, EventArgs e)
        {
        ...
        public void BuscarUsuarioPedateadoInasistencia()
        {
            ...
            dataGridView1.DataSource = cn_logistica.BuscarPedateoPersonalComedorInasistencia(
            dateTimePicker_Comedor_F_Inicio.Value.Date, dateTimePicker_Fecha_Final.Value.Date, adicional, area
            , tipopersonal, emp, sede, dni);
            dataGridView1.AllowUserToAddRows = false;
            SumarTotal();
            OrigenColorfila();
            dataGridView1.ClearSelection();
