...
{
    public partial class Frm_CargarCampamentoBunker : Form
    {
        private DataSet dtsTablas = new DataSet();
        private DataSet dtsTablasLicencia = new DataSet();
        cn_servpersonal objcnlog = new cn_servpersonal();


        public Frm_CargarCampamentoBunker()
        {
            InitializeComponent();
        }

        private void Frm_CargarCampamentoBunker_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
            //poner osucro
        ...
        public void Cargar_Empresa()
        {
            ...
            comboBox_empresa.ValueMember = "id"; // NOMBRE DE LA COLUMNA o PARA 
        ...
        public void GuardarCampamentoBunker()
        {
            ...
            {
                objcnlog.EliminarCampamento(
                        comboBox_empresa.Text.Trim(),
                        comboBox_Sede.Text.Trim(),
                        comboBox_Año.Text,
                        comboBox_Semana.Text
                        );
                ...
                {
                    objcnlog.GuardarCampamentoBunker(
                        comboBox_empresa.Text,
                        comboBox_Sede.Text,
                        dataGridView1[0, i].Value.ToString().ToUpper().Trim(),//pabellon
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//n
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//campamento
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//dni
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//reponsable
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//sexo
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//gerencia
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//area
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//cargo
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//lugar resi
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//cond_aloja
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//cond_contrato
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//capacidad
                        dataGridView1[13, i].Value.ToString().ToUpper().Trim(),//ocupabilidad
                        dataGridView1[14, i].Value.ToString().ToUpper().Trim(),//disponibilidad
                        dataGridView1[15, i].Value.ToString().ToUpper().Trim(),//dias campamento
                        dataGridView1[16, i].Value.ToString().ToUpper().Trim(),//OBS
