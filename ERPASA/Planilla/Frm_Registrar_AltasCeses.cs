...
{
    public partial class Frm_Registrar_AltasCeses : Form
    {
        ...
        public Frm_Registrar_AltasCeses()
        {
            InitializeComponent();
        }

        private void Frm_Registrar_AltasCeses_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
        ...
        public void GuardarAltasCeses()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    cn_planilla.BuscExisteAltasCeses(
                            comboBox_empresa.Text,
                        dataGridView1[0, i].Value.ToString().Trim()
                        , Convert.ToDateTime(dataGridView1[8, i].Value).Date);
                    if (dataGridView1[0, i].Value.ToString().Trim() == ce_planilla.codAlta & Convert.ToDateTime(dataGridView1[8, i].Value).Date == ce_planilla.FechaMovimiento.Date)
                    {

                        objcnlog.ActualizarAltasCeses(
                        ...
                        Convert.ToDateTime(dataGridView1[3, i].Value).Date,//FECING_EMPRESA
                        Convert.ToDateTime(dataGridView1[4, i].Value).Date,//FECING_PLANILLA
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//EST_ANT
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//ESTA_ACTUAL
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//MOT_CESE
                        Convert.ToDateTime(dataGridView1[8, i].Value).Date,//FEC_MOVIMIENTO
                        dataGridView1[9, i].Value.ToString(),//COD_CESE
                            comboBox_empresa.Text,
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//NOMBRE CC
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//GERENCIA
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//AREA
                        dataGridView1[13, i].Value.ToString().ToUpper().Trim(),//CARGO
                        dataGridView1[14, i].Value.ToString().ToUpper().Trim(),//TIPOJORNADA
                        dataGridView1[15, i].Value.ToString().ToUpper().Trim(),//ZONA
