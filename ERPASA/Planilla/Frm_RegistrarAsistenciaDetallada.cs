...
{
    public partial class Frm_RegistrarAsistenciaDetallada : Form
    {
        ...
        public Frm_RegistrarAsistenciaDetallada()
        {
            InitializeComponent();
        }

        private void Frm_RegistrarAsistenciaDetallada_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
        ...
        public void GuardarAsistenciaDetallada()
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    var extasiste = cn_planilla.BuscExisteAsistenciaDetallada(
                       dataGridView1[2, i].Value.ToString().Trim(),
                       Convert.ToDateTime(dataGridView1[0, i].Value).Date);

                    if (extasiste == true)
                    {
                        objcnlog.ActualizarAsistenciaDetallada(
                        ...
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//APE NOM
                        dataGridView1[4, i].Value.ToString().ToUpper().Trim(),//HORA INGRESO
                        dataGridView1[5, i].Value.ToString().ToUpper().Trim(),//HORA SALIDA
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//HORA SAL REFRI
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//HORA RET REFRI
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//OBSERVACION
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//PUNTO LLEGADA
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//GERENCIA
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//AREA
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//SUB AREA
                        dataGridView1[13, i].Value.ToString().ToUpper().Trim(),//CARGO
                        dataGridView1[14, i].Value.ToString().ToUpper().Trim(),//COD PLANILLA
                        dataGridView1[15, i].Value.ToString().ToUpper().Trim(),//USUARIO REG
                    ...
                    else //if (dataGridView2[0, i].Value.ToString() != ce_nisira.CodUsuarioExiste) //if (dr.Cells[0].Value.ToString() != ce_rolesbi.CodExiste)
                    {
                        ...
                        objcnlog.GuardarAsistenciaDetallada(
                        Convert.ToDateTime(dataGridView1[0, i].Value).Date,//fecha
                        dataGridView1[1, i].Value.ToString().ToUpper().Trim(),//EMPRESA
                        dataGridView1[2, i].Value.ToString().ToUpper().Trim(),//DNI
                        dataGridView1[3, i].Value.ToString().ToUpper().Trim(),//APE NOM
