...
{
    public partial class Frm_Registrar_PlanillaTrabajador : Form
    {
        ...
        public Frm_Registrar_PlanillaTrabajador()
        {
            InitializeComponent();
        }

        private void Frm_Registrar_PlanillaTrabajador_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
