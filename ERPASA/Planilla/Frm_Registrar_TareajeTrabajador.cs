...
{
    public partial class Frm_Registrar_TareajeTrabajador : Form
    {
        ...
        public Frm_Registrar_TareajeTrabajador()
        {
            InitializeComponent();
        }

        private void Frm_Registrar_TareajeTrabajador_Load(object sender, EventArgs e)
        {
            //ALTO RIESGO
        ...
        public void GuardarTareajeTrabajador()
        {
            ...
            {
                objcnlog.EliminarTareajeTrabajador(
                        comboBox_empresa.Text.Trim(),
                        dateTimePicker_Tareaje_trabajador.Value.ToString()
                        );
                ...
                //foreach (DataGridViewRow dr in dataGridView1.Rows)
                {
                    ...
                    objcnlog.GuardarActualizarTareajeTrabajador(
                        ...
                        dateTimePicker_Tareaje_trabajador.Text,//FECHA TAREADO
                        dataGridView1[3, i].Value.ToString().Trim(),//FEC INGRESO
                        dataGridView1[4, i].Value.ToString(),//FECING CESE
                                                             //Convert.ToDecimal(dataGridView1[5, i].Value),//PERMANENCIA
                        dataGridView1[5, i].Value.ToString(),//COD_CESE
                        dataGridView1[6, i].Value.ToString().ToUpper().Trim(),//NOMBRE CC
                        dataGridView1[7, i].Value.ToString().ToUpper().Trim(),//GERENCIA
                        dataGridView1[8, i].Value.ToString().ToUpper().Trim(),//AREA
                        dataGridView1[9, i].Value.ToString().ToUpper().Trim(),//CARGO
                        dataGridView1[10, i].Value.ToString().ToUpper().Trim(),//TIPOJORNADA
                        dataGridView1[11, i].Value.ToString().ToUpper().Trim(),//ZONA
                        dataGridView1[12, i].Value.ToString().ToUpper().Trim(),//EST_TRAB
        ...
        {
            //MessageBox.Show("" + dateTimePicker_Tareaje_trabajador.Text);
        }
    }
}
